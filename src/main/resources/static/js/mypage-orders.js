...
function s() {
	let [e, t] = (0, i.useState)([]), [n, r] = (0, i.useState)(!0), [a, s] = (0, i.useState)(() => new URLSearchParams(window.location.search).get("keyword") || ""), [c, l] = (0, i.useState)(() => new URLSearchParams(window.location.search).get("period") || "6months"), [u, d] = (0, i.useState)(!1), [f, p] = (0, i.useState)({
		trackingNumber: "",
		status: "READY",
		companyName: ""
	}), [m, h] = (0, i.useState)({
		...
		step2Active: !1,
		step3Active: !1
	}), g = (0, i.useRef)(null), [_, v] = (0, i.useState)(!1), [y, b] = (0, i.useState)(!1), [x, S] = (0, i.useState)({
		isOpen: !1,
		type: "",
		title: "",
		text: "",
		...
		resultMessage: "",
		payload: {}
	}), [C, w] = (0, i.useState)({}), T = async (e, n) => {
		r(!0);
		try {
			let r = new URLSearchParams();
			e && r.append("keyword", e), n && r.append("period", n);
			let i = await fetch(`/api/mypage/orders?${r.toString()}`);
			if (!i.ok) throw Error("데이터 수집 실패");
			t(await i.json());
		} catch (e) {
	...
	let E = (e) => {
		...
		a ? t.set("keyword", a) : t.delete("keyword"), t.set("period", c), window.history.replaceState({}, "", `${window.location.pathname}?${t.toString()}`), T(a, c);
	}, D = (e) => {
		l(e);
		let t = new URLSearchParams(window.location.search);
		t.set("period", e), a ? t.set("keyword", a) : t.delete("keyword"), window.history.replaceState({}, "", `${window.location.pathname}?${t.toString()}`), T(a, e);
	}, O = (e, t, n) => {
		g.current &&= (clearTimeout(g.current), null);
		let r = t || "READY", i = "0%", a = !1, o = !1, s = !1;
		r !== "CANCELED" && r !== "FAILED" && (r === "READY" ? (a = !0, i = "0%") : r === "SHIPPING" || r === "DELAYED" ? (a = !0, o = !0, i = "50%") : r === "DELIVERED" && (a = !0, o = !0, s = !0, i = "100%")), p({
			trackingNumber: e,
			status: r,
			companyName: n
		}), h({
		...
		d(!1), g.current && clearTimeout(g.current), g.current = setTimeout(() => {
			h({
				trackingNumber: "-",
				status: "READY",
				companyName: "",
		...
		let { orderSeq: e, orderItemSeqList: t } = x.payload;
		try {
		...
		S({
			...
			type: "CANCEL",
			title: "주문 취소 확인",
			text: `${r.length > 1 ? `[${i} 외 ${r.length - 1}건]` : `[${i}]`}을 정말 주문 취소하시겠습니까?<br/><br/><span class="text-xs text-red-500 font-bold">※ 배송 준비 중이므로 즉시 환불 처리됩니다.</span>`,
			step: "CONFIRM",
			isSuccess: !1,
			resultTitle: "",
			resultMessage: "",
		...
		let n = t.items.map((e) => e.orderItemSeq).filter((e) => C[e] === !0);
		if (n.length === 0) {
			b(!0);
			return;
		}
		let r = t.items.filter((e) => n.includes(e.orderItemSeq))[0].name;
		S({
			isOpen: !0,
			type: "RETURN",
			title: "반품 신청 확인",
			text: `${n.length > 1 ? `[${r} 외 ${n.length - 1}건]` : `[${r}]`}을 정말 반품 신청하시겠습니까?<br/><br/><span class="text-xs text-amber-500 font-bold">※ 반품 신청 완료 후 택배 수거 및 검수가 진행됩니다.</span>`,
			step: "CONFIRM",
			isSuccess: !1,
			resultTitle: "",
			resultMessage: "",
	...
	return /* @__PURE__ */ (0, o.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, o.jsx)("div", {
				...
				}) : e && e.length > 0 ? /* @__PURE__ */ (0, o.jsx)("div", {
					class: "space-y-5",
										...
										children: [/* @__PURE__ */ (0, o.jsx)("div", {
											...
											children: t.items.map((e) => /* @__PURE__ */ (0, o.jsxs)("div", {
												...
												children: [
													t.deliveryStatus === "DELIVERED" && ![
														...
														type: "checkbox",
														checked: !!C[e.orderItemSeq],
														onChange: (t) => A(e.orderItemSeq, t.target.checked),
													...
													/* @__PURE__ */ (0, o.jsx)("a", {
														...
														children: /* @__PURE__ */ (0, o.jsxs)("div", {
															...
															children: [
																...
																[7, 8].includes(e.itemStatus) && /* @__PURE__ */ (0, o.jsx)("div", {
																	class: "absolute inset-0 bg-slate-900/45 flex items-center justify-center",
																	children: /* @__PURE__ */ (0, o.jsx)("span", {
																		class: "text-[11px] font-black text-white border border-white/60 px-2 py-1 rounded",
																		children: "반품대기"
											...
											children: /* @__PURE__ */ (0, o.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, o.jsx)("button", {
														type: "button",
														onClick: () => O(t.trackingNumber, t.deliveryStatus, t.companyName),
													...
													i ? /* @__PURE__ */ (0, o.jsx)("button", {
														type: "button",
														onClick: () => N(e.orderSeq, t),
														className: `btn-action py-2.5 border text-sm shadow-sm transition-all ${t.deliveryStatus === "READY" ? "border-red-200 text-red-600 bg-red-50 hover:bg-red-100" : "border-slate-200 text-slate-500 bg-white hover:bg-slate-50"}`,
														children: "주문취소"
													}) : /* @__PURE__ */ (0, o.jsx)("button", {
														type: "button",
														disabled: !0,
			...
			/* @__PURE__ */ (0, o.jsx)("div", {
				id: "trackModal",
				className: `modal-overlay ${u ? "active" : ""}`,
				onClick: (e) => e.target.id === "trackModal" && k(),
				children: /* @__PURE__ */ (0, o.jsxs)("div", {
					class: "modal-content",
					children: [
						/* @__PURE__ */ (0, o.jsx)("h3", {
							...
							children: /* @__PURE__ */ (0, o.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, o.jsx)("div", {
										...
										style: { width: m.stepProgressWidth }
									}),
									/* @__PURE__ */ (0, o.jsxs)("div", {
										id: "step1",
										class: "flex flex-col items-center flex-1 relative z-10",
										children: [/* @__PURE__ */ (0, o.jsx)("div", {
											className: `step-circle w-10 h-10 rounded-full flex items-center justify-center border-2 font-bold transition-all duration-300 ${m.step1Active ? "bg-blue-500 border-blue-500 text-white shadow-md shadow-blue-100" : "bg-slate-100 border-slate-200 text-slate-400"}`,
											children: /* @__PURE__ */ (0, o.jsx)("svg", {
												class: "w-5 h-5",
												fill: "none",
												stroke: "currentColor",
											...
											className: `step-label text-xs font-bold mt-2 transition-all ${m.step1Active ? "text-blue-600" : "text-slate-400"}`,
											children: "배송대기"
										})]
									}),
									/* @__PURE__ */ (0, o.jsxs)("div", {
										...
										class: "flex flex-col items-center flex-1 relative z-10",
										children: [/* @__PURE__ */ (0, o.jsx)("div", {
											className: `step-circle w-10 h-10 rounded-full flex items-center justify-center border-2 font-bold transition-all duration-300 ${m.step2Active ? "bg-blue-500 border-blue-500 text-white shadow-md shadow-blue-100" : "bg-slate-100 border-slate-200 text-slate-400"}`,
											children: /* @__PURE__ */ (0, o.jsx)("svg", {
												class: "w-5 h-5",
												fill: "none",
												stroke: "currentColor",
											...
											className: `step-label text-xs font-bold mt-2 transition-all ${m.step2Active ? "text-blue-600" : "text-slate-400"}`,
											children: "중간허브도착"
										})]
									}),
									/* @__PURE__ */ (0, o.jsxs)("div", {
										...
										class: "flex flex-col items-center flex-1 relative z-10",
										children: [/* @__PURE__ */ (0, o.jsx)("div", {
											className: `step-circle w-10 h-10 rounded-full flex items-center justify-center border-2 font-bold transition-all duration-300 ${m.step3Active ? "bg-blue-500 border-blue-500 text-white shadow-md shadow-blue-100" : "bg-slate-100 border-slate-200 text-slate-400"}`,
											children: /* @__PURE__ */ (0, o.jsx)("svg", {
												class: "w-5 h-5",
												fill: "none",
												stroke: "currentColor",
											...
											className: `step-label text-xs font-bold mt-2 transition-all ${m.step3Active ? "text-blue-600" : "text-slate-400"}`,
											children: "배송완료"
										})]
									})
								]
						...
						/* @__PURE__ */ (0, o.jsxs)("p", {
							...
							children: ["현재 배송 상태: ", /* @__PURE__ */ (0, o.jsx)("span", {
								id: "modalStatusText",
								className: `font-bold ${m.status === "CANCELED" || m.status === "FAILED" ? "text-red-600" : "text-blue-600"}`,
								children: m.status
							})]
						}),
						/* @__PURE__ */ (0, o.jsxs)("div", {
			...
			/* @__PURE__ */ (0, o.jsx)("div", {
				...
				onClick: (e) => e.target.id === "cancelAlertModal" && v(!1),
				children: /* @__PURE__ */ (0, o.jsxs)("div", {
					class: "modal-content",
					children: [
						/* @__PURE__ */ (0, o.jsx)("div", {
			...
			/* @__PURE__ */ (0, o.jsx)("div", {
				...
				onClick: (e) => e.target.id === "returnNoSelectionModal" && b(!1),
				children: /* @__PURE__ */ (0, o.jsxs)("div", {
					class: "modal-content",
					children: [
						/* @__PURE__ */ (0, o.jsx)("div", {
			...
			/* @__PURE__ */ (0, o.jsx)("div", {
				id: "confirmModal",
				className: `modal-overlay ${x.isOpen ? "active" : ""}`,
				onClick: (e) => {
					e.target.id === "confirmModal" && x.step !== "PROCESSING" && S((e) => ({
						...e,
						isOpen: !1
					}));
				},
				children: /* @__PURE__ */ (0, o.jsxs)("div", {
					class: "modal-content",
					children: [
						x.step === "CONFIRM" && /* @__PURE__ */ (0, o.jsxs)("div", {
							id: "confirmStep",
							children: [
								/* @__PURE__ */ (0, o.jsx)("div", {
									className: `w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 border ${x.type === "CANCEL" ? "bg-red-50 border-red-100 text-red-500" : "bg-amber-50 border-amber-100 text-amber-500"}`,
									children: /* @__PURE__ */ (0, o.jsx)("svg", {
										class: "w-8 h-8",
										fill: "none",
										stroke: "currentColor",
								...
								/* @__PURE__ */ (0, o.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, o.jsx)("button", {
										...
										onClick: x.type === "CANCEL" ? j : M,
										className: `flex-1 text-white font-bold py-3.5 rounded-xl transition-colors text-sm shadow-md ${x.type === "CANCEL" ? "bg-red-500 hover:bg-red-600 shadow-red-100" : "bg-amber-500 hover:bg-amber-600 shadow-amber-100"}`,
										children: "예, 진행합니다"
									})]
								})
							]
						}),
						x.step === "PROCESSING" && /* @__PURE__ */ (0, o.jsxs)("div", {
							id: "processingStep",
							class: "py-6",
							children: [
						...
						x.step === "RESULT" && /* @__PURE__ */ (0, o.jsxs)("div", {
							id: "resultStep",
							children: [
								/* @__PURE__ */ (0, o.jsx)("div", {
									className: `w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 border ${x.isSuccess ? "bg-emerald-50 border-emerald-100 text-emerald-500" : "bg-red-50 border-red-100 text-red-500"}`,
									children: x.isSuccess ? /* @__PURE__ */ (0, o.jsx)("svg", {
										class: "w-8 h-8",
										fill: "none",
										stroke: "currentColor",
										viewBox: "0 0 24 24",
								...
								/* @__PURE__ */ (0, o.jsx)("h3", {
									class: "text-xl font-bold text-slate-900 mb-2",
									children: x.resultTitle
								}),
								/* @__PURE__ */ (0, o.jsx)("p", {
									class: "text-slate-500 text-sm mb-6 leading-relaxed",
									children: x.resultMessage
								}),
								/* @__PURE__ */ (0, o.jsx)("button", {
									onClick: () => {
										S((e) => ({
