...
var o = (e, t, n) => Math.max(Math.min(e, n), t);
function s(e) {
	return o(a(e * 2.55), 0, 255);
}
function c(e) {
	return o(a(e * 255), 0, 255);
}
function l(e) {
	return o(a(e / 2.55) / 100, 0, 1);
}
function u(e) {
	return o(a(e * 100), 0, 100);
}
var d = {
	0: 0,
	1: 1,
	...
	e: 14,
	f: 15
}, f = [..."0123456789ABCDEF"], p = (e) => f[e & 15], m = (e) => f[(e & 240) >> 4] + f[e & 15], h = (e) => (e & 240) >> 4 == (e & 15), g = (e) => h(e.r) && h(e.g) && h(e.b) && h(e.a);
function _(e) {
	var t = e.length, n;
	return e[0] === "#" && (t === 4 || t === 5 ? n = {
		...
		g: d[e[3]] << 4 | d[e[4]],
		b: d[e[5]] << 4 | d[e[6]],
		a: t === 9 ? d[e[7]] << 4 | d[e[8]] : 255
	})), n;
}
var v = (e, t) => e < 255 ? t(e) : "";
function y(e) {
	var t = g(e) ? p : m;
	return e ? "#" + t(e.r) + t(e.g) + t(e.b) + v(e.a, t) : void 0;
}
var b = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function x(e, t, n) {
...
function T(e) {
	...
	return i !== a && (l = i - a, c = o > .5 ? l / (2 - i - a) : l / (i + a), s = w(t, n, r, l, i), s = s * 60 + .5), [
		s | 0,
		c || 0,
		o
	];
...
function E(e, t, n, r) {
	return (Array.isArray(t) ? e(t[0], t[1], t[2]) : e(t, n, r)).map(c);
}
function D(e, t, n) {
	return E(x, e, t, n);
}
...
function ne(e) {
	let t = b.exec(e), n = 255, r;
	if (!t) return;
	t[5] !== r && (n = t[6] ? s(+t[5]) : c(+t[5]));
	let i = te(+t[2]), a = t[3] / 100, o = t[4] / 100;
	return r = t[1] === "hwb" ? ee(i, a, o) : t[1] === "hsv" ? O(i, a, o) : D(i, a, o), {
		r: r[0],
		g: r[1],
		b: r[2],
		a: n
...
function re(e, t) {
	var n = T(e);
	n[0] = te(n[0] + t), n = D(n), e.r = n[0], e.g = n[1], e.b = n[2];
}
function ie(e) {
	if (!e) return;
	let t = T(e), n = t[0], r = u(t[1]), i = u(t[2]);
	return e.a < 255 ? `hsla(${n}, ${r}%, ${i}%, ${l(e.a)})` : `hsl(${n}, ${r}%, ${i}%)`;
}
var ae = {
	x: "dark",
	Z: "light",
...
function se() {
	let e = {}, t = Object.keys(oe), n = Object.keys(ae), r, i, a, o, s;
	for (r = 0; r < t.length; r++) {
		for (o = s = t[r], i = 0; i < n.length; i++) a = n[i], s = s.replace(a, ae[a]);
		a = parseInt(oe[o], 16), e[s] = [
			a >> 16 & 255,
			a >> 8 & 255,
			a & 255
		];
...
var ce;
function le(e) {
	ce || (ce = se(), ce.transparent = [
		0,
		0,
		0,
		0
	]);
	let t = ce[e.toLowerCase()];
	return t && {
		r: t[0],
		g: t[1],
		b: t[2],
...
function de(e) {
	let t = ue.exec(e), n = 255, r, i, a;
	if (t) {
		if (t[7] !== r) {
			let e = +t[7];
			n = t[8] ? s(e) : o(e * 255, 0, 255);
		}
		return r = +t[1], i = +t[3], a = +t[5], r = 255 & (t[2] ? s(r) : o(r, 0, 255)), i = 255 & (t[4] ? s(i) : o(i, 0, 255)), a = 255 & (t[6] ? s(a) : o(a, 0, 255)), {
			r,
			g: i,
			b: a,
			a: n
...
function fe(e) {
	return e && (e.a < 255 ? `rgba(${e.r}, ${e.g}, ${e.b}, ${l(e.a)})` : `rgb(${e.r}, ${e.g}, ${e.b})`);
}
var pe = (e) => e <= .0031308 ? e * 12.92 : e ** (1 / 2.4) * 1.055 - .055, me = (e) => e <= .04045 ? e / 12.92 : ((e + .055) / 1.055) ** 2.4;
function he(e, t, n) {
	let r = me(l(e.r)), i = me(l(e.g)), a = me(l(e.b));
	return {
		r: c(pe(r + n * (me(l(t.r)) - r))),
		g: c(pe(i + n * (me(l(t.g)) - i))),
		b: c(pe(a + n * (me(l(t.b)) - a))),
		a: e.a + n * (t.a - e.a)
	};
}
function ge(e, t, n) {
	if (e) {
		let r = T(e);
		r[t] = Math.max(0, Math.min(r[t] + r[t] * n, t === 0 ? 360 : 1)), r = D(r), e.r = r[0], e.g = r[1], e.b = r[2];
	}
}
function _e(e, t) {
...
function ye(e) {
	return e.charAt(0) === "r" ? de(e) : ne(e);
}
var be = class e {
	constructor(t) {
		if (t instanceof e) return t;
		let n = typeof t, r;
		n === "object" ? r = ve(t) : n === "string" && (r = _(t) || le(t) || ye(t)), this._rgb = r, this._valid = !!r;
	}
	get valid() {
		return this._valid;
	}
	...
	rgbString() {
		return this._valid ? fe(this._rgb) : void 0;
	}
	hexString() {
		return this._valid ? y(this._rgb) : void 0;
	}
	hslString() {
	...
	greyscale() {
		let e = this._rgb;
		return e.r = e.g = e.b = a(e.r * .3 + e.g * .59 + e.b * .11), this;
	}
	opaquer(e) {
		let t = this._rgb;
		return t.a *= 1 + e, this;
	...
	lighten(e) {
		return ge(this._rgb, 2, e), this;
	}
	darken(e) {
		return ge(this._rgb, 2, -e), this;
	}
	saturate(e) {
		return ge(this._rgb, 1, e), this;
	}
	desaturate(e) {
		return ge(this._rgb, 1, -e), this;
	}
	rotate(e) {
		return re(this._rgb, e), this;
	}
};
//#endregion
...
var Ce = (e, t) => typeof e == "string" && e.endsWith("%") ? parseFloat(e) / 100 : +e / t, we = (e, t) => typeof e == "string" && e.endsWith("%") ? parseFloat(e) / 100 * t : +e;
function F(e, t, n) {
	if (e && typeof e.call == "function") return e.apply(n, t);
}
function I(e, t, n, r) {
	let i, a, o;
	if (A(e)) if (a = e.length, r) for (i = a - 1; i >= 0; i--) t.call(n, e[i], i);
	else for (i = 0; i < a; i++) t.call(n, e[i], i);
	else if (j(e)) for (o = Object.keys(e), a = o.length, i = 0; i < a; i++) t.call(n, e[o[i]], o[i]);
}
function Te(e, t) {
	let n, r, i, a;
...
function Oe(e, t, n, r) {
	if (!De(e)) return;
	let i = t[e], a = n[e];
	j(i) && j(a) ? ke(i, a, r) : t[e] = Ee(a);
}
function ke(e, t, n) {
	let r = A(t) ? t : [t], i = r.length;
	if (!j(e)) return e;
	n ||= {};
	let a = n.merger || Oe, o;
	for (let t = 0; t < i; ++t) {
		if (o = r[t], !j(o)) continue;
		let i = Object.keys(o);
...
function Ae(e, t) {
	return ke(e, t, { merger: je });
}
function je(e, t, n) {
	if (!De(e)) return;
	let r = t[e], i = n[e];
	j(r) && j(i) ? Ae(r, i) : Object.prototype.hasOwnProperty.call(t, e) || (t[e] = Ee(i));
}
var Me = {
	"": (e) => e,
	x: (e) => e.x,
...
function Fe(e, t) {
	return (Me[t] || (Me[t] = Pe(t)))(e);
}
function Ie(e) {
	return e.charAt(0).toUpperCase() + e.slice(1);
}
var Le = (e) => e !== void 0, Re = (e) => typeof e == "function", ze = (e, t) => {
...
var L = Math.PI, R = 2 * L, Ve = R + L, He = Infinity, Ue = L / 180, z = L / 2, We = L / 4, Ge = L * 2 / 3, Ke = Math.log10, B = Math.sign;
function qe(e, t, n) {
...
function Je(e) {
	let t = Math.round(e);
	e = qe(e, t, e / 1e3) ? t : e;
	let n = 10 ** Math.floor(Ke(e)), r = e / n;
...
function Ze(e) {
	return !Xe(e) && !isNaN(parseFloat(e)) && isFinite(e);
}
function Qe(e, t) {
	let n = Math.round(e);
	return n - t <= e && n + t >= e;
...
function at(e, t, n, r) {
	let i = H(e), a = H(t), o = H(n), s = H(a - i), c = H(o - i), l = H(i - a), u = H(i - o);
...
function ot(e) {
	return U(e, -32768, 32767);
}
function st(e, t, n, r = 1e-6) {
...
var lt = (e, t, n, r) => ct(e, n, r ? (r) => {
	let i = e[r][t];
	return i < n || i === n && e[r + 1][t] === n;
} : (r) => e[r][t] < n), ut = (e, t, n) => ct(e, n, (r) => e[r][t] >= n);
function dt(e, t, n) {
	let r = 0, i = e.length;
	for (; r < i && e[r] < t;) r++;
	for (; i > r && e[i - 1] > n;) i--;
...
function mt(e, t) {
	...
	i !== -1 && r.splice(i, 1), !(r.length > 0) && (ft.forEach((t) => {
		delete e[t];
	}), delete e._chartjs);
}
function ht(e) {
...
var yt = (e) => e === "start" ? "left" : e === "end" ? "right" : "center", W = (e, t, n) => e === "start" ? t : e === "end" ? n : (t + n) / 2, bt = (e, t, n, r) => e === (r ? "left" : "right") ? n : e === "center" ? (t + n) / 2 : t;
function xt(e, t, n) {
	...
	if (e._sorted) {
		...
		if (p) {
			if (i = Math.min(lt(c, u, d).lo, n ? r : lt(t, u, o.getPixelForValue(d)).lo), l) {
				let e = c.slice(0, i + 1).reverse().findIndex((e) => !k(e[s.axis]));
				i -= Math.max(0, e);
			}
			i = U(i, 0, r - 1);
		}
		if (m) {
			let e = Math.max(lt(c, o.axis, f, !0).hi + 1, n ? 0 : lt(t, u, o.getPixelForValue(f), !0).hi + 1);
			if (l) {
				let t = c.slice(e - 1).findIndex((e) => !k(e[s.axis]));
				e += Math.max(0, t);
			}
			a = U(e, i, r) - i;
		} else a = r - i;
...
var Ct = (e) => e === 0 || e === 1, wt = (e, t, n) => -(2 ** (10 * --e) * Math.sin((e - t) * R / n)), Tt = (e, t, n) => 2 ** (-10 * e) * Math.sin((e - t) * R / n) + 1, Et = {
	linear: (e) => e,
	easeInQuad: (e) => e * e,
	easeOutQuad: (e) => -e * (e - 2),
	...
	easeInSine: (e) => -Math.cos(e * z) + 1,
	easeOutSine: (e) => Math.sin(e * z),
	easeInOutSine: (e) => -.5 * (Math.cos(L * e) - 1),
	easeInExpo: (e) => e === 0 ? 0 : 2 ** (10 * (e - 1)),
	easeOutExpo: (e) => e === 1 ? 1 : -(2 ** (-10 * e)) + 1,
	easeInOutExpo: (e) => Ct(e) ? e : e < .5 ? .5 * 2 ** (10 * (e * 2 - 1)) : .5 * (-(2 ** (-10 * (e * 2 - 1))) + 2),
	easeInCirc: (e) => e >= 1 ? e : -(Math.sqrt(1 - e * e) - 1),
	easeOutCirc: (e) => Math.sqrt(1 - --e * e),
	easeInOutCirc: (e) => (e /= .5) < 1 ? -.5 * (Math.sqrt(1 - e * e) - 1) : .5 * (Math.sqrt(1 - (e -= 2) * e) + 1),
	easeInElastic: (e) => Ct(e) ? e : wt(e, .075, .3),
	easeOutElastic: (e) => Ct(e) ? e : Tt(e, .075, .3),
	easeInOutElastic(e) {
		let t = .1125, n = .45;
		return Ct(e) ? e : e < .5 ? .5 * wt(e * 2, t, n) : .5 + .5 * Tt(e * 2 - 1, t, n);
	},
	easeInBack(e) {
	...
	easeInOutBounce: (e) => e < .5 ? Et.easeInBounce(e * 2) * .5 : Et.easeOutBounce(e * 2 - 1) * .5 + .5
};
function Dt(e) {
...
function Ot(e) {
	return Dt(e) ? e : new be(e);
}
function kt(e) {
	return Dt(e) ? e : new be(e).saturate(.5).darken(.1).hexString();
}
var At = [
	"x",
	"y",
...
function Ft(e, t) {
	t ||= {};
	let n = e + JSON.stringify(t), r = Pt.get(n);
	return r || (r = new Intl.NumberFormat(e, t), Pt.set(n, r)), r;
}
function It(e, t, n) {
	return Ft(t, n).format(e);
}
var Lt = {
	values(e) {
		return A(e) ? e : "" + e;
	...
	numeric(e, t, n) {
		...
		if (n.length > 1) {
			...
			(t < 1e-4 || t > 0x38d7ea4c68000) && (i = "scientific"), a = Rt(e, n);
		}
		let o = Ke(Math.abs(a)), s = isNaN(o) ? 1 : Math.max(Math.min(-1 * Math.floor(o), 20), 0), c = {
			notation: i,
			minimumFractionDigits: s,
			maximumFractionDigits: s
		};
		return Object.assign(c, this.options.ticks.format), It(e, r, c);
	},
	logarithmic(e, t, n) {
		if (e === 0) return "0";
		let r = n[t].significand || e / 10 ** Math.floor(Ke(e));
		return [
			1,
			2,
			3,
			...
			10,
			15
		].includes(r) || t > .8 * n.length ? Lt.numeric.call(this, e, t, n) : "";
	}
};
function Rt(e, t) {
...
var Vt = Object.create(null), Ht = Object.create(null);
function Ut(e, t) {
	if (!t) return e;
	let n = t.split(".");
...
function Wt(e, t, n) {
	return typeof t == "string" ? ke(Ut(e, t), n) : ke(Ut(e, ""), t);
}
var G = /* #__PURE__ */ new class {
	constructor(e, t) {
		this.animation = void 0, this.backgroundColor = "rgba(0,0,0,0.1)", this.borderColor = "rgba(0,0,0,0.1)", this.color = "#666", this.datasets = {}, this.devicePixelRatio = (e) => e.chart.platform.getDevicePixelRatio(), this.elements = {}, this.events = [
			...
			lineHeight: 1.2,
			weight: null
		}, this.hover = {}, this.hoverBackgroundColor = (e, t) => kt(t.backgroundColor), this.hoverBorderColor = (e, t) => kt(t.borderColor), this.hoverColor = (e, t) => kt(t.color), this.indexAxis = "x", this.interaction = {
			mode: "nearest",
			intersect: !0,
			includeInvisible: !1
	...
	route(e, t, n, r) {
		let i = Ut(this, e), a = Ut(this, n), o = "_" + t;
		Object.defineProperties(i, {
			...
			[t]: {
				...
				get() {
					let e = this[o], t = a[r];
					return j(e) ? Object.assign({}, t, e) : P(e, t);
				},
				set(e) {
					this[o] = e;
				}
...
function qt(e, t, n, r) {
	...
	for (c = 0; c < s; c++) if (d = n[c], d != null && !A(d)) o = Kt(e, i, a, o, d);
	else if (A(d)) for (l = 0, u = d.length; l < u; l++) f = d[l], f != null && !A(f) && (o = Kt(e, i, a, o, f));
	e.restore();
	let p = a.length / 2;
	if (p > n.length) {
...
function Zt(e, t, n, r, i) {
	let a, o, s, c, l, u, d, f, p = t.pointStyle, m = t.rotation, h = t.radius, g = (m || 0) * Ue;
	...
	if (!(isNaN(h) || h <= 0)) {
		switch (e.beginPath(), p) {
			default:
				i ? e.ellipse(n, r, i / 2, h, 0, 0, R) : e.arc(n, r, h, 0, R), e.closePath();
				break;
			case "triangle":
				u = i ? i / 2 : h, e.moveTo(n + Math.sin(g) * u, r - Math.cos(g) * h), g += Ge, e.lineTo(n + Math.sin(g) * u, r - Math.cos(g) * h), g += Ge, e.lineTo(n + Math.sin(g) * u, r - Math.cos(g) * h), e.closePath();
				break;
			case "rectRounded":
				l = h * .516, c = h - l, o = Math.cos(g + We) * c, d = Math.cos(g + We) * (i ? i / 2 - l : c), s = Math.sin(g + We) * c, f = Math.sin(g + We) * (i ? i / 2 - l : c), e.arc(n - d, r - s, l, g - L, g - z), e.arc(n + f, r - o, l, g - z, g), e.arc(n + d, r + s, l, g, g + z), e.arc(n - f, r + o, l, g + z, g + L), e.closePath();
				break;
			case "rect":
				if (!m) {
			...
			case "cross":
				...
				break;
			case "star":
				d = Math.cos(g) * (i ? i / 2 : h), o = Math.cos(g) * h, s = Math.sin(g) * h, f = Math.sin(g) * (i ? i / 2 : h), e.moveTo(n - d, r - s), e.lineTo(n + d, r + s), e.moveTo(n + f, r - o), e.lineTo(n - f, r + o), g += We, d = Math.cos(g) * (i ? i / 2 : h), o = Math.cos(g) * h, s = Math.sin(g) * h, f = Math.sin(g) * (i ? i / 2 : h), e.moveTo(n - d, r - s), e.lineTo(n + d, r + s), e.moveTo(n + f, r - o), e.lineTo(n - f, r + o);
				break;
			case "line":
...
function sn(e, t, n, r, i, a = {}) {
	let o = A(t) ? t : [t], s = a.strokeWidth > 0 && a.strokeColor !== "", c, l;
	for (e.save(), e.font = i.string, rn(e, a), c = 0; c < o.length; ++c) l = o[c], a.backdrop && on(e, a.backdrop), s && (a.strokeColor && (e.strokeStyle = a.strokeColor), k(a.strokeWidth) || (e.lineWidth = a.strokeWidth), e.strokeText(l, n, r, a.maxWidth)), e.fillText(l, n, r, a.maxWidth), an(e, n, r, l, a), r += Number(i.lineHeight);
	e.restore();
}
function cn(e, t) {
	let { x: n, y: r, w: i, h: a, radius: o } = t;
	e.arc(n + o.topLeft, r + o.topLeft, o.topLeft, 1.5 * L, L, !0), e.lineTo(n, r + a - o.bottomLeft), e.arc(n + o.bottomLeft, r + a - o.bottomLeft, o.bottomLeft, L, z, !0), e.lineTo(n + i - o.bottomRight, r + a), e.arc(n + i - o.bottomRight, r + a - o.bottomRight, o.bottomRight, z, 0, !0), e.lineTo(n + i, r + o.topRight), e.arc(n + i - o.topRight, r + o.topRight, o.topRight, 0, -z, !0), e.lineTo(n + o.topLeft, r);
}
var ln = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/, un = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function dn(e, t) {
	let n = ("" + e).match(ln);
...
var fn = (e) => +e || 0;
function pn(e, t) {
	let n = {}, r = j(t), i = r ? Object.keys(t) : t, a = j(e) ? r ? (n) => P(e[n], e[t[n]]) : (t) => e[t] : () => e;
	for (let e of i) n[e] = fn(a(e));
	return n;
}
function mn(e) {
	return pn(e, {
...
function q(e, t) {
	...
	r && !("" + r).match(un) && (console.warn("Invalid font style specified: \"" + r + "\""), r = void 0);
	let i = {
		family: P(e.family, t.family),
		lineHeight: dn(P(e.lineHeight, t.lineHeight), n),
		size: n,
		style: r,
		weight: P(e.weight, t.weight),
		string: ""
	};
	return i.string = Gt(i), i;
}
function gn(e, t, n, r) {
	let i = !0, a, o, s;
	for (a = 0, o = e.length; a < o; ++a) if (s = e[a], s !== void 0 && (t !== void 0 && typeof s == "function" && (s = s(t), i = !1), n !== void 0 && A(s) && (s = s[n % s.length], i = !1), s !== void 0)) return r && !i && (r.cacheable = !1), s;
}
function _n(e, t, n) {
	let { min: r, max: i } = e, a = we(t, (i - r) / 2), o = (e, t) => n && e === 0 ? 0 : e + t;
	return {
		min: o(r, -Math.abs(a)),
		max: o(i, a)
	};
...
function yn(e, t = [""], n, r, i = () => e[0]) {
	let a = n || e;
	return r === void 0 && (r = Fn("_fallback", e)), new Proxy({
		...
		_fallback: r,
		_getTarget: i,
		override: (n) => yn([n, ...e], t, a, r)
	}, {
		deleteProperty(t, n) {
			return delete t[n], delete t._keys, delete e[0][n], !0;
		},
		get(n, r) {
			return wn(n, r, () => Pn(r, t, e, n));
		},
...
function bn(e, t, n, r) {
	let i = {
		...
		_descriptors: xn(e, r),
		setContext: (t) => bn(e, t, n, r),
		override: (i) => bn(e.override(i), t, n, r)
	};
	return new Proxy(i, {
		deleteProperty(t, n) {
...
function xn(e, t = {
	...
	return {
		...
		isIndexable: Re(r) ? r : () => r
	};
}
var Sn = (e, t) => e ? e + Ie(t) : t, Cn = (e, t) => j(t) && e !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function wn(e, t, n) {
...
function Tn(e, t, n) {
	...
	return Re(s) && o.isScriptable(t) && (s = En(t, s, e, n)), A(s) && s.length && (s = Dn(t, s, e, o.isIndexable)), Cn(t, s) && (s = bn(s, i, a && a[t], o)), s;
}
function En(e, t, n, r) {
	...
	s.add(e);
	let c = t(a, o || r);
	return s.delete(e), Cn(e, c) && (c = jn(i._scopes, i, e, c)), c;
}
function Dn(e, t, n, r) {
...
var kn = (e, t) => e === !0 ? t : typeof e == "string" ? Fe(t, e) : void 0;
function An(e, t, n, r, i) {
	for (let a of t) {
		let t = kn(n, a);
		if (t) {
			e.add(t);
			let a = On(t._fallback, n, i);
...
function jn(e, t, n, r) {
	let i = t._rootScopes, a = On(t._fallback, n, r), o = [...e, ...i], s = /* @__PURE__ */ new Set();
	s.add(r);
	let c = Mn(s, o, n, a || n, r);
	return c === null || a !== void 0 && a !== n && (c = Mn(s, o, a, c, r), c === null) ? !1 : yn(Array.from(s), [""], i, a, () => Nn(t, n, r));
}
function Mn(e, t, n, r, i) {
	for (; n;) n = An(e, t, n, r, i);
	return n;
}
function Nn(e, t, n) {
	let r = e._getTarget();
...
function Pn(e, t, n, r) {
	let i;
	for (let a of t) if (i = Fn(Sn(a, e), n), i !== void 0) return Cn(e, i) ? jn(n, r, e, i) : i;
}
function Fn(e, t) {
	for (let n of t) {
		if (!n) continue;
...
function In(e) {
	let t = e._keys;
	return t ||= e._keys = Ln(e._scopes), t;
}
function Ln(e) {
...
function Rn(e, t, n, r) {
	...
	for (s = 0, c = r; s < c; ++s) l = s + n, u = t[l], o[s] = { r: i.parse(Fe(u, a), l) };
	return o;
}
var zn = 2 ** -52 || 1e-14, Bn = (e, t) => t < e.length && !e[t].skip && e[t], Vn = (e) => e === "x" ? "y" : "x";
function Hn(e, t, n, r) {
	let i = e.skip ? t : e, a = t, o = n.skip ? t : n, s = rt(a, i), c = rt(o, a), l = s / (s + c), u = c / (s + c);
...
function Un(e, t, n) {
	let r = e.length, i, a, o, s, c, l = Bn(e, 0);
	for (let u = 0; u < r - 1; ++u) if (c = l, l = Bn(e, u + 1), !(!c || !l)) {
		if (qe(t[u], 0, zn)) {
			n[u] = n[u + 1] = 0;
			continue;
		}
...
function Wn(e, t, n = "x") {
	let r = Vn(n), i = e.length, a, o, s, c = Bn(e, 0);
	for (let l = 0; l < i; ++l) {
		if (o = s, s = c, c = Bn(e, l + 1), !s) continue;
		let i = s[n], u = s[r];
		o && (a = (i - o[n]) / 3, s[`cp1${n}`] = i - a, s[`cp1${r}`] = u - a * t[l]), c && (a = (c[n] - i) / 3, s[`cp2${n}`] = i + a, s[`cp2${r}`] = u + a * t[l]);
	}
}
function Gn(e, t = "x") {
	let n = Vn(t), r = e.length, i = Array(r).fill(0), a = Array(r), o, s, c, l = Bn(e, 0);
	for (o = 0; o < r; ++o) if (s = c, c = l, l = Bn(e, o + 1), c) {
		if (l) {
			let e = l[t] - c[t];
			i[o] = e === 0 ? 0 : (l[n] - c[n]) / e;
		}
		a[o] = s ? l ? B(i[o - 1]) === B(i[o]) ? (i[o - 1] + i[o]) / 2 : 0 : i[o - 1] : i[o];
	}
	Un(e, i, a), Wn(e, a, t);
}
function Kn(e, t, n) {
...
function qn(e, t) {
	let n, r, i, a, o, s = Qt(e[0], t);
	for (n = 0, r = e.length; n < r; ++n) o = a, a = s, s = n < r - 1 && Qt(e[n + 1], t), a && (i = e[n], o && (i.cp1x = Kn(i.cp1x, t.left, t.right), i.cp1y = Kn(i.cp1y, t.top, t.bottom)), s && (i.cp2x = Kn(i.cp2x, t.left, t.right), i.cp2y = Kn(i.cp2y, t.top, t.bottom)));
}
function Jn(e, t, n, r, i) {
	let a, o, s, c;
	if (t.spanGaps && (e = e.filter((e) => !e.skip)), t.cubicInterpolationMode === "monotone") Gn(e, i);
	else {
		let n = r ? e[e.length - 1] : e[0];
		for (a = 0, o = e.length; a < o; ++a) s = e[a], c = Hn(n, s, e[Math.min(a + 1, o - +!r) % o], t.tension), s.cp1x = c.previous.x, s.cp1y = c.previous.y, s.cp2x = c.next.x, s.cp2y = c.next.y, n = s;
	}
	t.capBezierPoints && qn(e, n);
}
function Yn() {
...
var Qn = (e) => e.ownerDocument.defaultView.getComputedStyle(e, null);
function $n(e, t) {
...
function ir(e, t) {
	...
	let { canvas: n, currentDevicePixelRatio: r } = t, i = Qn(n), a = i.boxSizing === "border-box", o = tr(i, "padding"), s = tr(i, "border", "width"), { x: c, y: l, box: u } = rr(e, n), d = o.left + (u && s.left), f = o.top + (u && s.top), { width: p, height: m } = t;
...
function ar(e, t, n) {
	...
	if (t === void 0 || n === void 0) {
		...
		if (!a) t = e.clientWidth, n = e.clientHeight;
			...
			let e = a.getBoundingClientRect(), o = Qn(a), s = tr(o, "border", "width"), c = tr(o, "padding");
			t = e.width - c.width - s.width, n = e.height - c.height - s.height, r = Zn(o.maxWidth, a, "clientWidth"), i = Zn(o.maxHeight, a, "clientHeight");
		}
	}
	return {
		width: t,
...
var or = (e) => Math.round(e * 10) / 10;
function sr(e, t, n, r) {
	let i = Qn(e), a = tr(i, "margin"), o = Zn(i.maxWidth, e, "clientWidth") || He, s = Zn(i.maxHeight, e, "clientHeight") || He, c = ar(e, t, n), { width: l, height: u } = c;
	if (i.boxSizing === "content-box") {
		let e = tr(i, "border", "width"), t = tr(i, "padding");
		l -= t.width + e.width, u -= t.height + e.height;
	}
	return l = Math.max(0, l - a.width), u = Math.max(0, r ? l / r : u - a.height), l = or(Math.min(l, o, c.maxWidth)), u = or(Math.min(u, s, c.maxHeight)), l && !u && (u = or(l / 2)), (t !== void 0 || n !== void 0) && r && c.height && u > c.height && (u = c.height, l = or(Math.floor(u * r))), {
		width: l,
		height: u
	};
}
function cr(e, t, n) {
	let r = t || 1, i = or(e.height * r), a = or(e.width * r);
	e.height = or(e.height), e.width = or(e.width);
	let o = e.canvas;
...
var lr = function() {
	...
	try {
		...
		Yn() && (window.addEventListener("test", null, t), window.removeEventListener("test", null, t));
	} catch {}
	return e;
}();
function ur(e, t) {
	let n = $n(e, t), r = n && n.match(/^(\d+)(\.\d+)?px$/);
	return r ? +r[1] : void 0;
}
function dr(e, t, n, r) {
	return {
...
function pr(e, t, n, r) {
	let i = {
		...
		x: t.cp1x,
		y: t.cp1y
	}, o = dr(e, i, n), s = dr(i, a, n), c = dr(a, t, n);
	return dr(dr(o, s, n), dr(s, c, n), n);
}
var mr = function(e, t) {
	return {
		x(n) {
...
function br({ start: e, end: t, count: n, loop: r, style: i }) {
	return {
		start: e % n,
		end: t % n,
		loop: r && (t - e + 1) % n === 0,
...
function xr(e, t, n) {
	let { property: r, start: i, end: a } = n, { between: o, normalize: s } = yr(r), c = t.length, { start: l, end: u, loop: d } = e, f, p;
	if (d) {
...
function Sr(e, t, n) {
	if (!n) return [e];
	let { property: r, start: i, end: a } = n, o = t.length, { compare: s, between: c, normalize: l } = yr(r), { start: u, end: d, loop: f, style: p } = xr(e, t, n), m = [], h = !1, g = null, _, v, y, b = () => c(i, y, _) && s(i, y) !== 0, x = () => s(a, _) === 0 || c(a, y, _), S = () => h || b(), C = () => !h || x();
	for (let e = u, n = u; e <= d; ++e) v = t[e % o], !v.skip && (_ = l(v[r]), _ !== y && (h = c(_, i, a), g === null && S() && (g = s(_, i) === 0 ? e : n), g !== null && C() && (m.push(br({
		start: g,
		end: e,
		loop: f,
		count: o,
...
function Er(e, t) {
	...
	if (!i) return [];
	let a = !!e._loop, { start: o, end: s } = wr(n, i, a, r);
	return r === !0 ? Dr(e, [{
		start: o,
		end: s,
		loop: a
	}], n, t) : Dr(e, Tr(n, o, s < o ? s + i : s, !!e._fullLoop && o === 0 && s === i - 1), n, t);
}
function Dr(e, t, n, r) {
	return !r || !r.setContext || !n ? t : Or(e, t, n, r);
}
function Or(e, t, n, r) {
	let i = e._chart.getContext(), a = kr(e.options), { _datasetIndex: o, options: { spanGaps: s } } = e, c = n.length, l = [], u = a, d = t[0].start, f = d;
	function p(e, t, r, i) {
		let a = s ? -1 : 1;
		if (e !== t) {
	...
	for (let e of t) {
		...
		for (f = d + 1; f <= e.end; f++) {
			...
			a = kr(r.setContext(vn(i, {
				...
				p1DataIndex: f % c,
				datasetIndex: o
			}))), Ar(a, u) && p(d, f - 1, e.loop, u), t = s, u = a;
		}
...
function Ar(e, t) {
	...
	let n = [], r = function(e, t) {
		return Dt(t) ? (n.includes(t) || n.push(t), n.indexOf(t)) : t;
	};
...
function Mr(e, t) {
	...
	return n && r ? {
		...
		right: jr(n, t, "right"),
		top: jr(r, t, "top"),
		bottom: jr(r, t, "bottom")
	} : t;
}
function Nr(e, t) {
	let n = t._clip;
	if (n.disabled) return !1;
	let r = Mr(t, e.chartArea);
	return {
...
var Pr = /* #__PURE__ */ new class {
	...
	_refresh() {
		this._request ||= (this._running = !0, gt.call(window, () => {
	...
	color(e, t, n) {
		let r = Ot(e || Fr), i = r.valid && Ot(t || Fr);
	...
	constructor(e, t, n, r) {
		...
		this._active = !0, this._fn = e.fn || Ir[e.type || typeof a], this._easing = Et[e.easing] || Et.linear, this._start = Math.floor(Date.now() + (e.delay || 0)), this._duration = this._total = Math.floor(e.duration), this._loop = !!e.loop, this._target = t, this._prop = n, this._from = a, this._to = r, this._promises = void 0;
	}
	active() {
		return this._active;
	}
	update(e, t, n) {
		if (this._active) {
			...
			this._start = n, this._duration = Math.floor(Math.max(a, e.duration)), this._total += i, this._loop = !!e.loop, this._to = gn([
				e.to,
				t,
				r,
				e.from
	...
	configure(e) {
		...
		Object.getOwnPropertyNames(e).forEach((r) => {
			...
			(A(i.properties) && i.properties || [r]).forEach((e) => {
				(e === r || !n.has(e)) && n.set(e, a);
			});
		});
	}
	_animateOptions(e, t) {
		let n = t.options, r = Br(e, n);
		if (!r) return [];
		let i = this._createAnimations(r, n);
		return n.$shared && zr(e.options.$animations, n).then(() => {
			e.options = n;
		}, () => {}), i;
	}
	...
	update(e, t) {
		...
		if (n.length) return Pr.add(this._chart, n), !0;
	}
};
function zr(e, t) {
...
function Ur(e) {
	let t, n, r, i;
	return j(e) ? (t = e.top, n = e.right, r = e.bottom, i = e.left) : t = n = r = i = e, {
		top: t,
		right: n,
		bottom: r,
		left: i,
...
function Gr(e, t, n, r = {}) {
	...
	for (o = 0, s = i.length; o < s; ++o) {
		...
		l = e.values[c], M(l) && (a || t === 0 || B(t) === B(l)) && (t += l);
	}
	return !u && !r.all ? 0 : t;
}
function Kr(e, t) {
...
function Qr(e, t) {
	let { chart: n, _cachedMeta: r } = e, i = n._stacks ||= {}, { iScale: a, vScale: o, index: s } = r, c = a.axis, l = o.axis, u = Jr(a, o, r), d = t.length, f;
	for (let e = 0; e < d; ++e) {
		let n = t[e], { [c]: a, [l]: d } = n, p = n._stacks ||= {};
		f = p[l] = Xr(i, u, a), f[s] = d, f._top = Zr(f, o, !0, r.type), f._bottom = Zr(f, o, !1, r.type);
...
var ri = (e) => e === "reset" || e === "none", ii = (e, t) => t ? e : Object.assign({}, e), ai = (e, t, n) => e && !t.hidden && t._stacked && {
	keys: Wr(n, !0),
	values: null
}, oi = class {
	static defaults = {};
	...
	initialize() {
		...
		this.configure(), this.linkScales(), e._stacked = qr(e.vScale, e), this.addElements(), this.options.fill && !this.chart.isPluginEnabled("filler") && console.warn("Tried to use the 'fill' option without the 'Filler' plugin enabled. Please import and register the 'Filler' plugin and make sure it is not disabled in the options");
	}
	updateIndex(e) {
		this.index !== e && ni(this._cachedMeta), this.index = e;
	}
	linkScales() {
		let e = this.chart, t = this._cachedMeta, n = this.getDataset(), r = (e, t, n, r) => e === "x" ? t : e === "r" ? r : n, i = t.xAxisID = P(n.xAxisID, $r(e, "x")), a = t.yAxisID = P(n.yAxisID, $r(e, "y")), o = t.rAxisID = P(n.rAxisID, $r(e, "r")), s = t.indexAxis, c = t.iAxisID = r(s, i, a, o), l = t.vAxisID = r(s, a, i, o);
	...
	_destroy() {
		let e = this._cachedMeta;
		this._data && mt(this._data, this), e._stacked && ni(e);
	}
	_dataCheck() {
		...
		if (j(t)) {
			...
			t && Object.isExtensible(t) && pt(t, this), this._syncList = [], this._data = t;
		}
	}
	addElements() {
		let e = this._cachedMeta;
	...
	buildOrUpdateElements(e) {
		...
		this._dataCheck();
		let i = t._stacked;
		t._stacked = qr(t.vScale, t), t.stack !== n.stack && (r = !0, ni(t), t.stack = n.stack), this._resyncElements(e), (r || i !== t._stacked) && (Qr(this, t._parsed), t._stacked = qr(t.vScale, t));
	}
	configure() {
	...
	parse(e, t) {
		...
		if (this._parsing === !1) n._parsed = r, n._sorted = !0, d = r;
			...
			d = A(r[e]) ? this.parseArrayData(n, r, e, t) : j(r[e]) ? this.parseObjectData(n, r, e, t) : this.parsePrimitiveData(n, r, e, t);
	...
	updateRangeFromParsed(e, t, n, r) {
		...
		r && o && (r.values = o, a = Gr(r, i, this._cachedMeta.index)), e.min = Math.min(e.min, a), e.max = Math.max(e.max, a);
	}
	getMinMax(e, t) {
		let n = this._cachedMeta, r = n._parsed, i = n._sorted && e === n.iScale, a = r.length, o = this._getOtherScale(e), s = ai(t, n, this.chart), c = {
			min: Infinity,
			max: -Infinity
		}, { min: l, max: u } = Yr(o), d, f;
		function p() {
			f = r[d];
			let t = f[o.axis];
			return !M(f[e.axis]) || l > t || u < t;
		}
	...
	getAllParsedValues(e) {
		...
		for (r = 0, i = t.length; r < i; ++r) a = t[r][e.axis], M(a) && n.push(a);
		return n;
	}
	getMaxOverflow() {
		return !1;
	...
	_update(e) {
		let t = this._cachedMeta;
		this.update(e || "default"), t._clip = Ur(P(this.options.clip, Hr(t.xScale, t.yScale, this.getMaxOverflow())));
	}
	update(e) {}
	draw() {
	...
	getContext(e, t, n) {
		...
		if (e >= 0 && e < this._cachedMeta.data.length) {
			...
			i = t.$context ||= ti(this.getContext(), e, t), i.parsed = this.getParsed(e), i.raw = r.data[e], i.index = i.dataIndex = e;
		} else i = this.$context ||= ei(this.chart.getContext(), this.index), i.dataset = r, i.index = i.datasetIndex = this.index;
	...
	_resolveElementOptions(e, t = "default", n) {
		let r = t === "active", i = this._cachedDataOpts, a = e + "-" + t, o = i[a], s = this.enableOptionSharing && Le(n);
		if (o) return ii(o, s);
		...
		return p.$shared && (p.$shared = s, i[a] = Object.freeze(ii(p, s))), p;
	}
	...
	includeOptions(e, t) {
		return !t || ri(e) || this.chart._animationsDisabled;
	}
	...
	updateElement(e, t, n, r) {
		ri(r) ? Object.assign(e, n) : this._resolveAnimations(t, r).update(e, n);
	}
	updateSharedOptions(e, t, n) {
		e && !ri(t) && this._resolveAnimations(void 0, t).update(e, n);
	}
	_setStyle(e, t, n, r) {
		e.active = r;
...
function si(e, t) {
	if (!e._cache.$bar) {
		...
		e._cache.$bar = ht(r.sort((e, t) => e - t));
	}
	return e._cache.$bar;
}
function ci(e) {
	let t = e.iScale, n = si(t, e.type), r = t._length, i, a, o, s, c = () => {
		o === 32767 || o === -32768 || (Le(s) && (r = Math.min(r, Math.abs(o - s) || r)), s = o);
	};
...
function li(e, t, n, r) {
	...
	return k(i) ? (a = t.min * n.categoryPercentage, o = n.barPercentage) : (a = i * r, o = 1), {
		chunk: a / r,
		ratio: o,
...
function fi(e, t, n, r) {
	return A(e) ? di(e, t, n, r) : t[n.axis] = n.parse(e, r), t;
}
function pi(e, t, n, r) {
	let i = e.iScale, a = e.vScale, o = i.getLabels(), s = i === a, c = [], l, u, d, f;
	for (l = n, u = n + r; l < u; ++l) f = t[l], d = {}, d[i.axis] = s || i.parse(o[l], l), c.push(fi(f, d, a, l));
	return c;
}
function mi(e) {
...
function hi(e, t, n) {
	return e === 0 ? (t.isHorizontal() ? 1 : -1) * (t.min >= n ? 1 : -1) : B(e);
}
function gi(e) {
	let t, n, r, i, a;
...
function _i(e, t, n, r) {
	...
	let { start: o, end: s, reverse: c, top: l, bottom: u } = gi(e);
	i === "middle" && n && (e.enableBorderRadius = !0, (n._top || 0) === r ? i = l : (n._bottom || 0) === r ? i = u : (a[vi(u, o, s, c)] = !0, i = l)), a[vi(i, o, s, c)] = !0, e.borderSkipped = a;
}
function vi(e, t, n, r) {
	return r ? (e = yi(e, t, n), e = bi(e, n, t)) : e = bi(e, t, n), e;
}
function yi(e, t, n) {
...
function xi(e, { inflateAmount: t }, n) {
...
var Si = class extends oi {
	...
	parseObjectData(e, t, n, r) {
		...
		for (d = n, f = n + r; d < f; ++d) m = t[d], p = {}, p[i.axis] = i.parse(Fe(m, c), d), u.push(fi(Fe(m, l), p, a, d));
		return u;
	}
	updateRangeFromParsed(e, t, n, r) {
	...
	getLabelAndValue(e) {
		let { iScale: t, vScale: n } = this._cachedMeta, r = this.getParsed(e), i = r._custom, a = mi(i) ? "[" + i.start + ", " + i.end + "]" : "" + n.getLabelForValue(r[n.axis]);
		return {
	...
	updateElements(e, t, n, r) {
		...
		for (let f = t; f < t + n; f++) {
			let t = this.getParsed(f), n = i || k(t[o.axis]) ? {
				base: s,
				head: s
			} : this._calculateBarValuePixels(f), p = this._calculateBarIndexPixels(f, l), m = (t._stacks || {})[o.axis], h = {
				horizontal: c,
				base: n.base,
				enableBorderRadius: !m || mi(t._custom) || a === m._top || a === m._bottom,
				x: c ? n.head : p.center,
				y: c ? p.center : n.head,
			...
			_i(h, g, m, a), xi(h, g, l.ratio), this.updateElement(e[f], f, h, r);
		}
	}
	_getStacks(e, t) {
	...
	_getAxis() {
		...
		for (let n of this.chart.data.datasets) e[P(this.chart.options.indexAxis === "x" ? n.xAxisID : n.yAxisID, t)] = !0;
	...
	_calculateBarValuePixels(e) {
		let { _cachedMeta: { vScale: t, _stacked: n, index: r }, options: { base: i, minBarLength: a } } = this, o = i || 0, s = this.getParsed(e), c = s._custom, l = mi(c), u = s[t.axis], d = 0, f = n ? this.applyStack(t, s, n) : u, p, m;
		f !== u && (d = f - u, f = u), l && (u = c.barStart, f = c.barEnd - c.barStart, u !== 0 && B(u) !== B(c.barEnd) && (d = 0), d += u);
		let h = !k(i) && !l ? i : d, g = t.getPixelForValue(h);
		if (p = this.chart.getDataVisibility(e) ? t.getPixelForValue(d + f) : g, m = p - g, Math.abs(m) < a) {
			m = hi(m, t, o) * a, u === o && (g -= m / 2);
		...
		if (g === t.getPixelForValue(o)) {
			let e = B(m) * t.getLineWidthForValue(o) / 2;
			g += e, m -= e;
		}
		return {
			size: m,
	...
	_calculateBarIndexPixels(e, t) {
		let n = t.scale, r = this.options, i = r.skipNull, a = P(r.maxBarThickness, Infinity), o, s, c = this._getAxisCount();
		if (t.grouped) {
			let n = i ? this._getStackCount(e) : t.stackCount, l = r.barThickness === "flex" ? ui(e, t, r, n * c) : li(e, t, r, n * c), u = this.chart.options.indexAxis === "x" ? this.getDataset().xAxisID : this.getDataset().yAxisID, d = this._getAxis().indexOf(P(u, this.getFirstScaleIdForIndexAxis())), f = this._getStackIndex(this.index, this._cachedMeta.stack, i ? e : void 0) + d;
	...
	parseArrayData(e, t, n, r) {
		...
		for (let e = 0; e < i.length; e++) {
			let r = t[n + e];
			i[e]._custom = P(r[2], this.resolveDataElementOptions(e + n).radius);
		}
		return i;
	}
	parseObjectData(e, t, n, r) {
		...
		for (let e = 0; e < i.length; e++) {
			let r = t[n + e];
			i[e]._custom = P(r && r.r && +r.r, this.resolveDataElementOptions(e + n).radius);
		}
		return i;
	}
	getMaxOverflow() {
	...
	resolveDataElementOptions(e, t) {
		...
		let i = r.radius;
		return t !== "active" && (r.radius = 0), r.radius += P(n && n._custom, i), r;
	}
};
function wi(e, t, n) {
	let r = 1, i = 1, a = 0, o = 0;
	if (t < R) {
		let s = e, c = s + t, l = Math.cos(s), u = Math.sin(s), d = Math.cos(c), f = Math.sin(c), p = (e, t, r) => at(e, s, c, !0) ? 1 : Math.max(t, t * n, r, r * n), m = (e, t, r) => at(e, s, c, !0) ? -1 : Math.min(t, t * n, r, r * n), h = p(0, l, d), g = p(z, u, f), _ = m(L, l, d), v = m(L + z, u, f);
...
var Ti = class extends oi {
	...
	update(e) {
		let { chartArea: t } = this.chart, n = this._cachedMeta, r = n.data, i = this.getMaxBorderWidth() + this.getMaxOffset(r) + this.options.spacing, a = Math.max((Math.min(t.width, t.height) - i) / 2, 0), o = Math.min(Ce(this.options.cutout, a), 1), s = this._getRingWeight(this.index), { circumference: c, rotation: l } = this._getRotationExtents(), { ratioX: u, ratioY: d, offsetX: f, offsetY: p } = wi(l, c, o), m = (t.width - i) / u, h = (t.height - i) / d, g = Math.max(Math.min(m, h) / 2, 0), _ = we(this.options.radius, g), v = (_ - Math.max(_ * o, 0)) / this._getVisibleDatasetWeightTotal();
	...
	_circumference(e, t) {
		...
		return t && n.animation.animateRotate || !this.chart.getDataVisibility(e) || r._parsed[e] === null || r.data[e].hidden ? 0 : this.calculateCircumference(r._parsed[e] * i / R);
	}
	updateElements(e, t, n, r) {
	...
	calculateCircumference(e) {
		...
		return t > 0 && !isNaN(e) ? Math.abs(e) / t * R : 0;
	}
	getLabelAndValue(e) {
		let t = this._cachedMeta, n = this.chart, r = n.data.labels || [], i = It(t._parsed[e], n.options.locale);
		return {
			label: r[e] || "",
			value: i
		};
	...
	_getRingWeight(e) {
		return Math.max(P(this.chart.data.datasets[e].weight, 1), 0);
	}
	...
	update(e) {
		let t = this._cachedMeta, { dataset: n, data: r = [], _dataset: i } = t, a = this.chart._animationsDisabled, { start: o, count: s } = xt(t, r, a);
		this._drawStart = o, this._drawCount = s, St(t) && (o = 0, s = r.length), n._chart = this.chart, n._datasetIndex = this.index, n._decimated = !!i._decimated, n.points = r;
	...
	updateElements(e, t, n, r) {
		let i = r === "reset", { iScale: a, vScale: o, _stacked: s, _dataset: c } = this._cachedMeta, { sharedOptions: l, includeOptions: u } = this._getSharedOptions(t, r), d = a.axis, f = o.axis, { spanGaps: p, segment: m } = this.options, h = Ze(p) ? p : Infinity, g = this.chart._animationsDisabled || i || r === "none", _ = t + n, v = e.length, y = t > 0 && this.getParsed(t - 1);
		for (let n = 0; n < v; ++n) {
			let p = e[n], v = g ? p : {};
			if (n < t || n >= _) {
				v.skip = !0;
			...
			let b = this.getParsed(n), x = k(b[f]), S = v[d] = a.getPixelForValue(b[d], n), C = v[f] = i || x ? o.getBasePixel() : o.getPixelForValue(s ? this.applyStack(o, b, s) : b[f], n);
	...
	getLabelAndValue(e) {
		let t = this._cachedMeta, n = this.chart, r = n.data.labels || [], i = It(t._parsed[e].r, n.options.locale);
		return {
			label: r[e] || "",
			value: i
		};
	...
	updateElements(e, t, n, r) {
		let i = r === "reset", a = this.chart, o = a.options.animation, s = this._cachedMeta.rScale, c = s.xCenter, l = s.yCenter, u = s.getIndexAngle(0) - .5 * L, d = u, f, p = 360 / this.countVisibleElements();
	...
	_computeAngle(e, t, n) {
		return this.chart.getDataVisibility(e) ? V(this.resolveDataElementOptions(e, t).angle || n) : 0;
	}
}, Oi = /*#__PURE__*/ Object.freeze({
	__proto__: null,
	BarController: Si,
	BubbleController: Ci,
	DoughnutController: Ti,
	LineController: Ei,
	PieController: class extends Ti {
		static id = "pie";
		static defaults = {
			cutout: 0,
			rotation: 0,
	...
	RadarController: class extends oi {
		static id = "radar";
		static defaults = {
			datasetElementType: "line",
			dataElementType: "point",
	...
	ScatterController: class extends oi {
		static id = "scatter";
		static defaults = {
			datasetElementType: !1,
			dataElementType: "point",
		...
		update(e) {
			let t = this._cachedMeta, { data: n = [] } = t, r = this.chart._animationsDisabled, { start: i, count: a } = xt(t, n, r);
			if (this._drawStart = i, this._drawCount = a, St(t) && (i = 0, a = n.length), this.options.showLine) {
		...
		updateElements(e, t, n, r) {
			let i = r === "reset", { iScale: a, vScale: o, _stacked: s, _dataset: c } = this._cachedMeta, l = this.resolveDataElementOptions(t, r), u = this.getSharedOptions(l), d = this.includeOptions(r, u), f = a.axis, p = o.axis, { spanGaps: m, segment: h } = this.options, g = Ze(m) ? m : Infinity, _ = this.chart._animationsDisabled || i || r === "none", v = t > 0 && this.getParsed(t - 1);
			for (let l = t; l < t + n; ++l) {
				let t = e[l], n = this.getParsed(l), m = _ ? t : {}, y = k(n[p]), b = m[f] = a.getPixelForValue(n[f], l), x = m[p] = i || y ? o.getBasePixel() : o.getPixelForValue(s ? this.applyStack(o, n, s) : n[p], l);
...
function ji(e, t, n, r) {
	...
	if (s && t === s.axis && t !== "r" && o && a.length) {
		let o = s._reversePixels ? ut : lt;
		if (!r) {
			let r = o(a, t, n);
			if (c) {
				let { vScale: t } = i._cachedMeta, { _parsed: n } = e, a = n.slice(0, r.lo + 1).reverse().findIndex((e) => !k(e[t.axis]));
				r.lo -= Math.max(0, a);
				let o = n.slice(r.hi).findIndex((e) => !k(e[t.axis]));
				r.hi += Math.max(0, o);
			}
			return r;
...
function Mi(e, t, n, r, i) {
	...
	for (let e = 0, n = a.length; e < n; ++e) {
		let { index: n, data: s } = a[e], { lo: c, hi: l } = ji(a[e], t, o, i);
		for (let e = c; e <= l; ++e) {
			let t = s[e];
			t.skip || r(t, n, e);
		}
...
function Pi(e, t, n, r, i) {
	let a = [];
	return !i && !e.isPointInArea(t) || Mi(e, n, t, function(n, o, s) {
		!i && !Qt(n, e.chartArea, 0) || n.inRange(t.x, t.y, r) && a.push({
			element: n,
			datasetIndex: o,
			index: s
		});
...
function Fi(e, t, n, r) {
	let i = [];
	function a(e, n, a) {
		let { startAngle: o, endAngle: s } = e.getProps(["startAngle", "endAngle"], r), { angle: c } = nt(e, {
			x: t.x,
			y: t.y
		});
		at(c, o, s) && i.push({
...
function Li(e, t, n, r, i, a) {
	return !a && !e.isPointInArea(t) ? [] : n === "r" && !r ? Fi(e, t, n, i) : Ii(e, t, n, r, i, a);
}
function Ri(e, t, n, r, i) {
	let a = [], o = n === "x" ? "inXRange" : "inYRange", s = !1;
	return Mi(e, n, t, (e, r, c) => {
...
var zi = {
	evaluateInteractionItems: Mi,
	modes: {
		index(e, t, n, r) {
			let i = ir(t, e), a = n.axis || "x", o = n.includeInvisible || !1, s = n.intersect ? Pi(e, i, a, r, o) : Li(e, i, a, !1, r, o), c = [];
		...
		dataset(e, t, n, r) {
			let i = ir(t, e), a = n.axis || "xy", o = n.includeInvisible || !1, s = n.intersect ? Pi(e, i, a, r, o) : Li(e, i, a, !1, r, o);
			if (s.length > 0) {
		...
		point(e, t, n, r) {
			return Pi(e, ir(t, e), n.axis || "xy", r, n.includeInvisible || !1);
		},
		nearest(e, t, n, r) {
			let i = ir(t, e), a = n.axis || "xy", o = n.includeInvisible || !1;
			return Li(e, i, a, n.intersect, r, o);
		},
		x(e, t, n, r) {
			return Ri(e, ir(t, e), "x", n.intersect, r);
		},
		y(e, t, n, r) {
			return Ri(e, ir(t, e), "y", n.intersect, r);
		}
	}
}, Bi = [
	"left",
...
function Hi(e, t) {
	return e.filter((e) => Bi.indexOf(e.pos) === -1 && e.box.axis === t);
}
function Ui(e, t) {
	return e.sort((e, n) => {
		let r = t ? n : e, i = t ? e : n;
...
function Ki(e, t) {
	let n = Gi(e), { vBoxMaxWidth: r, hBoxMaxHeight: i } = t, a, o, s;
...
function qi(e) {
	let t = Wi(e), n = Ui(t.filter((e) => e.box.fullSize), !0), r = Ui(Vi(t, "left"), !0), i = Ui(Vi(t, "right")), a = Ui(Vi(t, "top"), !0), o = Ui(Vi(t, "bottom")), s = Hi(t, "x"), c = Hi(t, "y");
	return {
		fullSize: n,
...
function Xi(e, t, n, r) {
	...
	let s = Math.max(0, t.outerWidth - Ji(o, e, "left", "right")), c = Math.max(0, t.outerHeight - Ji(o, e, "top", "bottom")), l = s !== e.w, u = c !== e.h;
...
function $i(e, t, n, r) {
	...
	for (a = 0, o = e.length, l = 0; a < o; ++a) {
		s = e[a], c = s.box, c.update(s.width || t.w, s.height || t.h, Qi(s.horizontal, t));
		let { same: o, other: d } = Xi(t, n, s, r);
		l |= o && i.length, u ||= d, c.fullSize || i.push(s);
	}
	return l && $i(i, t, n, r) || u;
}
...
function ta(e, t, n, r) {
	...
	for (let s of e) {
		...
		if (s.horizontal) {
			...
			Le(c.start) && (o = c.start), e.fullSize ? ea(e, i.left, o, n.outerWidth - i.right - i.left, a) : ea(e, t.left + c.placed, o, r, a), c.start = o, c.placed += r, o = e.bottom;
		} else {
			let r = t.h * l, o = c.size || e.width;
			Le(c.start) && (a = c.start), e.fullSize ? ea(e, a, i.top, o, n.outerHeight - i.bottom - i.top) : ea(e, a, t.top + c.placed, o, r), c.start = a, c.placed += r, a = e.right;
		}
	}
	t.x = a, t.y = o;
}
var J = {
	...
	update(e, t, n, r) {
		if (!e) return;
		let i = K(e.options.layout.padding), a = Math.max(t - i.width, 0), o = Math.max(n - i.height, 0), s = qi(e.boxes), c = s.vertical, l = s.horizontal;
		I(e.boxes, (e) => {
		...
		$i(s.fullSize, p, d, m), $i(c, p, d, m), $i(l, p, d, m) && $i(c, p, d, m), Zi(p), ta(s.leftAndTop, p, d, m), p.x += p.w, p.y += p.h, ta(s.rightAndBottom, p, d, m), e.chartArea = {
			left: p.left,
			top: p.top,
			right: p.left + p.w,
			bottom: p.top + p.h,
...
function sa(e, t) {
	...
	} }, n.display = n.display || "block", n.boxSizing = n.boxSizing || "border-box", oa(i)) {
		let t = ur(e, "width");
		t !== void 0 && (e.width = t);
	}
	if (oa(r)) if (e.style.height === "") e.height = e.width / (t || 2);
	else {
		let t = ur(e, "height");
		t !== void 0 && (e.height = t);
	}
...
var ca = lr ? { passive: !0 } : !1;
function la(e, t, n) {
	e && e.addEventListener(t, n, ca);
}
function ua(e, t, n) {
	e && e.canvas && e.canvas.removeEventListener(t, n, ca);
}
function da(e, t) {
	let n = aa[e.type] || e.type, { x: r, y: i } = ir(e, t);
	return {
		type: n,
		chart: t,
		native: e,
...
function pa(e, t, n) {
	let r = e.canvas, i = new MutationObserver((e) => {
		let t = !1;
		for (let n of e) t ||= fa(n.addedNodes, r), t &&= !fa(n.removedNodes, r);
		t && n();
	});
...
function ma(e, t, n) {
	let r = e.canvas, i = new MutationObserver((e) => {
		let t = !1;
		for (let n of e) t ||= fa(n.removedNodes, r), t &&= !fa(n.addedNodes, r);
		t && n();
	});
	return i.observe(document, {
		childList: !0,
...
var ha = /* @__PURE__ */ new Map(), ga = 0;
function _a() {
	let e = window.devicePixelRatio;
	e !== ga && (ga = e, ha.forEach((t, n) => {
		n.currentDevicePixelRatio !== e && t();
	}));
}
function va(e, t) {
	ha.size || window.addEventListener("resize", _a), ha.set(e, t);
}
function ya(e) {
	ha.delete(e), ha.size || window.removeEventListener("resize", _a);
}
function ba(e, t, n) {
	let r = e.canvas, i = r && Xn(r);
	if (!i) return;
	let a = _t((e, t) => {
		let r = i.clientWidth;
	...
	return o.observe(i), va(e, a), o;
}
function xa(e, t, n) {
	n && n.disconnect(), t === "resize" && ya(e);
}
function Sa(e, t, n) {
	let r = e.canvas, i = _t((t) => {
		e.ctx !== null && n(da(t, e));
	}, e);
	return la(r, t, i), i;
}
var Ca = class extends na {
	acquireContext(e, t) {
		let n = e && e.getContext && e.getContext("2d");
		return n && n.canvas === e ? (sa(e, t), n) : null;
	}
	releaseContext(e) {
		let t = e.canvas;
		if (!t[ia]) return !1;
...
function wa(e) {
	return !Yn() || typeof OffscreenCanvas < "u" && e instanceof OffscreenCanvas ? ra : Ca;
}
var Ta = class {
	static defaults = {};
...
function Ea(e, t) {
	let n = e.options.ticks, r = Da(e), i = Math.min(n.maxTicksLimit || r, r), a = n.major.enabled ? ka(t) : [], o = a.length, s = a[0], c = a[o - 1], l = [];
	if (o > i) return Aa(t, l, a, o / i), l;
	let u = Oa(a, t, i);
	if (o > 0) {
		let e, n, r = o > 1 ? Math.round((c - s) / (o - 1)) : null;
		for (ja(t, l, u, k(r) ? 0 : s - r, s), e = 0, n = o - 1; e < n; e++) ja(t, l, u, a[e], a[e + 1]);
		return ja(t, l, u, c, k(r) ? t.length : c + r), l;
	}
	return ja(t, l, u), l;
}
function Da(e) {
...
function ja(e, t, n, r, i) {
	let a = P(r, 0), o = Math.min(P(i, e.length), e.length), s = 0, c, l, u;
...
var Na = (e) => e === "left" ? "right" : e === "right" ? "left" : e, Pa = (e, t, n) => t === "top" || t === "left" ? e[t] + n : e[t] - n, Fa = (e, t) => Math.min(t || e, e);
function Ia(e, t) {
...
function Ba(e, t) {
	...
	let n = q(e.font, t), r = K(e.padding);
	return (A(e.text) ? e.text.length : 1) * n.lineHeight + r.height;
}
function Va(e, t) {
	return vn(e, {
		scale: t,
...
function Ua(e, t, n) {
	let r = yt(e);
	return (n && t !== "right" || !n && t === "right") && (r = Na(r)), r;
}
function Wa(e, t, n, r) {
	...
	if (e.isHorizontal()) {
		...
		} else m = n === "center" ? (l.bottom + l.top) / 2 + h - t : Pa(e, n, t);
		f = s - a;
	} else {
		if (j(n)) {
			let e = Object.keys(n)[0], r = n[e];
			p = u[e].getPixelForValue(r) - g + t;
		} else p = n === "center" ? (l.left + l.right) / 2 - g + t : Pa(e, n, t);
		m = W(r, o, i), d = n === "left" ? -z : z;
	}
	return {
		titleX: p,
		titleY: m,
...
var Ga = class e extends Ta {
	...
	getUserBounds() {
		...
		return e = N(e, Infinity), t = N(t, -Infinity), n = N(n, Infinity), r = N(r, -Infinity), {
			min: N(e, n),
			max: N(t, r),
			minDefined: M(e),
			maxDefined: M(t)
	...
	_callHooks(e) {
		this.chart.notifyPlugins(e, this.getContext()), F(this.options[e], [this]);
	}
	beforeDataLimits() {
	...
	generateTickLabels(e) {
		...
		for (n = 0, r = e.length; n < r; n++) i = e[n], i.label = F(t.callback, [
			i.value,
			n,
			e
		], this);
	...
	calculateLabelRotation() {
		let e = this.options, t = e.ticks, n = Fa(this.ticks.length, e.ticks.maxTicksLimit), r = t.minRotation || 0, i = t.maxRotation, a = r, o, s, c;
		if (!this._isVisible() || !t.display || r >= i || n <= 1 || !this.isHorizontal()) {
			this.labelRotation = r;
			return;
		}
		let l = this._getLabelSizes(), u = l.widest.width, d = l.highest.height, f = U(this.chart.width - u, 0, this.maxWidth);
		o = e.offset ? this.maxWidth / n : f / (n - 1), u + 6 > o && (o = f / (n - (e.offset ? .5 : 1)), s = this.maxHeight - za(e.grid) - t.padding - Ba(e.title, this.chart.options.font), c = Math.sqrt(u * u + d * d), a = et(Math.min(Math.asin(U((l.highest.height + 6) / o, -1, 1)), Math.asin(U(s / c, -1, 1)) - Math.asin(U(d / c, -1, 1)))), a = Math.max(r, Math.min(i, a))), this.labelRotation = a;
	}
	...
	fit() {
		...
		if (a) {
			let a = Ba(r, t.options.font);
			if (o ? (e.width = this.maxWidth, e.height = za(i) + a) : (e.height = this.maxHeight, e.width = za(i) + a), n.display && this.ticks.length) {
				let { first: t, last: r, widest: i, highest: a } = this._getLabelSizes(), s = n.padding * 2, c = V(this.labelRotation), l = Math.cos(c), u = Math.sin(c);
				if (o) {
	...
	_convertTicksToLabels(e) {
		...
		let t, n;
		for (t = 0, n = e.length; t < n; t++) k(e[t].label) && (e.splice(t, 1), n--, t--);
	...
	_getLabelSizes() {
		...
		if (!e) {
			...
			t < n.length && (n = Ia(n, t)), this._labelSizes = e = this._computeLabelSizes(n, n.length, this.options.ticks.maxTicksLimit);
		}
		return e;
	}
	_computeLabelSizes(e, t, n) {
		let { ctx: r, _longestTextCache: i } = this, a = [], o = [], s = Math.floor(t / Fa(t, n)), c = 0, l = 0, u, d, f, p, m, h, g, _, v, y, b;
		for (u = 0; u < t; u += s) {
			if (p = e[u].label, m = this._resolveTickFontOptions(u), r.font = h = m.string, g = i[h] = i[h] || {
				data: {},
				gc: []
			}, _ = m.lineHeight, v = y = 0, !k(p) && !A(p)) v = Kt(r, g.data, g.gc, v, p), y = _;
			else if (A(p)) for (d = 0, f = p.length; d < f; ++d) b = p[d], !k(b) && !A(b) && (v = Kt(r, g.data, g.gc, v, b), y += _);
	...
	getPixelForDecimal(e) {
		...
		return ot(this._alignToPixels ? Jt(this.chart, t, 0) : t);
	}
	...
	getContext(e) {
		...
		if (e >= 0 && e < t.length) {
			let n = t[e];
			return n.$context ||= Ha(this.getContext(), e, n);
		}
		return this.$context ||= Va(this.chart.getContext(), this);
	}
	_tickSize() {
		let e = this.options.ticks, t = V(this.labelRotation), n = Math.abs(Math.cos(t)), r = Math.abs(Math.sin(t)), i = this._getLabelSizes(), a = e.autoSkipPadding || 0, o = i ? i.widest.width + a : 0, s = i ? i.highest.height + a : 0;
	...
	_computeGridLineItems(e) {
		let t = this.axis, n = this.chart, r = this.options, { grid: i, position: a, border: o } = r, s = i.offset, c = this.isHorizontal(), l = this.ticks.length + +!!s, u = za(i), d = [], f = o.setContext(this.getContext()), p = f.display ? f.width : 0, m = p / 2, h = function(e) {
			return Jt(n, e, p);
		...
		let ee = P(r.ticks.maxTicksLimit, l), O = Math.max(1, Math.ceil(l / ee));
		for (_ = 0; _ < l; _ += O) {
			...
			v = La(this, _, s), v !== void 0 && (y = Jt(n, v, a), c ? b = S = w = E = y : x = C = T = D = y, d.push({
				tx1: b,
				ty1: x,
				tx2: S,
				ty2: C,
	...
	_computeLabelItems(e) {
		let t = this.axis, n = this.options, { position: r, ticks: i } = n, a = this.isHorizontal(), o = this.ticks, { align: s, crossAlign: c, padding: l, mirror: u } = i, d = za(n.grid), f = d + l, p = u ? -l : f, m = -V(this.labelRotation), h = [], g, _, v, y, b, x, S, C, w, T, E, D, ee = "middle";
		...
		for (g = 0, _ = o.length; g < _; ++g) {
			...
			C = this.getPixelForTick(g) + i.labelOffset, w = this._resolveTickFontOptions(g), T = w.lineHeight, E = A(y) ? y.length : 1;
			...
			if (e.showLabelBackdrop) {
				let t = K(e.backdropPadding), n = O.heights[g], r = O.widths[g], i = D - t.top, a = 0 - t.left;
				switch (ee) {
					case "middle":
						i -= n / 2;
						break;
	...
	_getXAxisLabelAlignment() {
		...
		if (-V(this.labelRotation)) return e === "top" ? "left" : "right";
		let n = "center";
	...
	drawBorder() {
		...
		this.isHorizontal() ? (c = Jt(e, this.left, a) - a / 2, l = Jt(e, this.right, o) + o / 2, u = d = s) : (u = Jt(e, this.top, a) - a / 2, d = Jt(e, this.bottom, o) + o / 2, c = l = s), t.save(), t.lineWidth = i.width, t.strokeStyle = i.color, t.beginPath(), t.moveTo(c, u), t.lineTo(l, d), t.stroke(), t.restore();
	}
	drawLabels(e) {
	...
	drawTitle() {
		...
		if (!n.display) return;
		let i = q(n.font), a = K(n.padding), o = n.align, s = i.lineHeight / 2;
		t === "bottom" || t === "center" || j(t) ? (s += a.bottom, A(n.text) && (s += i.lineHeight * (n.text.length - 1))) : s += a.top;
		let { titleX: c, titleY: l, maxWidth: u, rotation: d } = Wa(this, s, t, o);
		sn(e, n.text, 0, 0, i, {
			color: n.color,
			maxWidth: u,
			rotation: d,
	...
	_layers() {
		let t = this.options, n = t.ticks && t.ticks.z || 0, r = P(t.grid && t.grid.z, -1), i = P(t.border && t.border.z, 0);
	...
	register(e) {
		...
		Ya(t) && (n = this.register(t));
		let r = this.items, i = e.id, a = this.scope + "." + i;
		if (!i) throw Error("class does not have id: " + e);
		return i in r ? a : (r[i] = e, qa(e, a, n), this.override && G.override(e.id, e.overrides), a);
	}
	get(e) {
		return this.items[e];
	}
	unregister(e) {
		...
		n in t && delete t[n], r && n in G[r] && (delete G[r][n], this.override && delete Vt[n]);
	}
};
function qa(e, t, n) {
	let r = ke(Object.create(null), [
		n ? G.get(n) : {},
		G.get(t),
		e.defaults
	]);
	G.set(t, r), e.defaultRoutes && Ja(t, e.defaultRoutes), e.descriptors && G.describe(t, e.descriptors);
}
function Ja(e, t) {
...
var Y = /* #__PURE__ */ new class {
	constructor() {
		this.controllers = new Ka(oi, "datasets", !0), this.elements = new Ka(Ta, "elements"), this.plugins = new Ka(Object, "plugins"), this.scales = new Ka(Ga, "scales"), this._typedRegistries = [
			this.controllers,
			this.scales,
			this.elements
		];
	...
	_each(e, t, n) {
		[...t].forEach((t) => {
			...
			n || r.isForType(t) || r === this.plugins && t.id ? this._exec(e, r, t) : I(t, (t) => {
				let r = n || this._getRegistryForType(t);
				this._exec(e, r, t);
			});
		});
	...
	_exec(e, t, n) {
		let r = Ie(e);
		F(n["before" + r], [], n), t[e](n), F(n["after" + r], [], n);
	}
	...
	_createDescriptors(e, t) {
		let n = e && e.config, r = P(n.options && n.options.plugins, {}), i = Za(n);
		return r === !1 && !t ? [] : $a(e, i, r, t);
	}
...
function Za(e) {
	let t = {}, n = [], r = Object.keys(Y.plugins.items);
	for (let e = 0; e < r.length; e++) n.push(Y.getPlugin(r[e]));
	let i = e.plugins || [];
	for (let e = 0; e < i.length; e++) {
		let r = i[e];
...
function $a(e, { plugins: t, localIds: n }, r, i) {
	let a = [], o = e.getContext();
	for (let s of t) {
		let t = s.id, c = Qa(r[t], i);
		c !== null && a.push({
			plugin: s,
			options: eo(e.config, {
				plugin: s,
...
function oo(e, ...t) {
	if (io(e)) return e;
	for (let n of t) {
		let t = n.axis || ao(n.position) || e.length > 1 && io(e[0].toLowerCase());
		if (t) return t;
	}
...
function co(e, t) {
	if (t.data && t.data.datasets) {
		...
		if (n.length) return so(e, "x", n[0]) || so(e, "y", n[0]);
	}
	return {};
}
function lo(e, t) {
	let n = Vt[e.type] || { scales: {} }, r = t.scales || {}, i = to(e.type, t), a = Object.create(null);
	return Object.keys(r).forEach((t) => {
		let o = r[t];
		if (!j(o)) return console.error(`Invalid scale configuration for scale: ${t}`);
		if (o._proxy) return console.warn(`Ignoring resolver passed as options for scale: ${t}`);
		let s = oo(t, o, co(t, e), G.scales[o.type]), c = ro(s, i), l = n.scales || {};
		a[t] = Ae(Object.create(null), [
			{ axis: s },
			o,
			l[s],
			l[c]
		...
		let i = n.type || e.type, o = n.indexAxis || to(i, t), s = (Vt[i] || {}).scales || {};
		Object.keys(s).forEach((e) => {
			let t = no(e, o), i = n[t + "AxisID"] || t;
			a[i] = a[i] || Object.create(null), Ae(a[i], [
				{ axis: t },
				r[i],
				s[e]
			]);
		...
		let t = a[e];
		Ae(t, [G.scales[t.type], G.scale]);
	}), a;
}
function uo(e) {
	let t = e.options ||= {};
	t.plugins = P(t.plugins, {}), t.scales = lo(e, t);
}
function fo(e) {
	return e ||= {}, e.datasets = e.datasets || [], e.labels = e.labels || [], e;
}
function po(e) {
	return e ||= {}, e.data = fo(e.data), uo(e), e;
}
var mo = /* @__PURE__ */ new Map(), ho = /* @__PURE__ */ new Set();
function go(e, t) {
	let n = mo.get(e);
	return n || (n = t(), mo.set(e, n), ho.add(n)), n;
}
var _o = (e, t, n) => {
	let r = Fe(t, n);
	r !== void 0 && e.add(r);
	...
	constructor(e) {
		this._config = po(e), this._scopeCache = /* @__PURE__ */ new Map(), this._resolverCache = /* @__PURE__ */ new Map();
	}
	get platform() {
	...
	update() {
		let e = this._config;
		this.clearCache(), uo(e);
	}
	clearCache() {
		this._scopeCache.clear(), this._resolverCache.clear();
	}
	datasetScopeKeys(e) {
		return go(e, () => [[`datasets.${e}`, ""]]);
	}
	datasetAnimationScopeKeys(e, t) {
		return go(`${e}.transition.${t}`, () => [[`datasets.${e}.transitions.${t}`, `transitions.${t}`], [`datasets.${e}`, ""]]);
	}
	...
	pluginScopeKeys(e) {
		...
		return go(`${n}-plugin-${t}`, () => [[`plugins.${t}`, ...e.additionalOptionScopes || []]]);
	}
	_cachedScopes(e, t) {
	...
	getOptionScopes(e, t, n) {
		...
		t.forEach((t) => {
			e && (s.add(e), t.forEach((t) => _o(s, e, t))), t.forEach((e) => _o(s, r, e)), t.forEach((e) => _o(s, Vt[i] || {}, e)), t.forEach((e) => _o(s, G, e)), t.forEach((e) => _o(s, Ht, e));
		});
		let c = Array.from(s);
		return c.length === 0 && c.push(Object.create(null)), ho.has(t) && a.set(t, c), c;
	}
	chartOptionScopes() {
	...
	resolveNamedOptions(e, t, n, r = [""]) {
		let i = { $shared: !0 }, { resolver: a, subPrefixes: o } = yo(this._resolverCache, e, r), s = a;
		if (xo(a, t)) {
			i.$shared = !1, n = Re(n) ? n() : n;
	...
	createResolver(e, t, n = [""], r) {
		let { resolver: i } = yo(this._resolverCache, e, n);
		return j(t) ? bn(i, t, void 0, r) : i;
	}
};
function yo(e, t, n) {
	let r = e.get(t);
...
var bo = (e) => j(e) && Object.getOwnPropertyNames(e).some((t) => Re(e[t]));
function xo(e, t) {
	let { isScriptable: n, isIndexable: r } = xn(e);
	for (let i of t) {
		let t = n(i), a = r(i), o = (a || t) && e[i];
		if (t && (Re(o) || bo(o)) || a && A(o)) return !0;
	}
	return !1;
}
var So = "4.5.1", Co = [
...
function wo(e, t) {
	return e === "top" || e === "bottom" || Co.indexOf(e) === -1 && t === "x";
}
function To(e, t) {
	return function(n, r) {
...
function Eo(e) {
	...
	t.notifyPlugins("afterRender"), F(n && n.onComplete, [e], t);
}
function Do(e) {
	let t = e.chart, n = t.options.animation;
	F(n && n.onProgress, [e], t);
}
function Oo(e) {
	return Yn() && typeof e == "string" ? e = document.getElementById(e) : e && e.length && (e = e[0]), e && e.canvas && (e = e.canvas), e;
}
var ko = {}, Ao = (e) => {
	let t = Oo(e);
...
var No = class {
	...
	constructor(e, t) {
		let n = this.config = new vo(t), r = Oo(e), i = Ao(r);
		...
		this.platform = new (n.platform || (wa(r)))(), this.platform.updateConfig(n);
		let o = this.platform.acquireContext(r, a.aspectRatio), s = o && o.canvas, c = s && s.height, l = s && s.width;
		if (this.id = Se(), this.ctx = o, this.canvas = s, this.width = l, this.height = c, this._options = a, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new Xa(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = vt((e) => this.update(e), a.resizeDelay || 0), this._dataChanges = [], ko[this.id] = this, !o || !s) {
			console.error("Failed to create chart: can't acquire context from the given item");
			return;
		}
		Pr.listen(this, "complete", Eo), Pr.listen(this, "progress", Do), this._initialize(), this.attached && this.update();
	}
	get aspectRatio() {
	...
	_initialize() {
		return this.notifyPlugins("beforeInit"), this.options.responsive ? this.resize() : cr(this, this.options.devicePixelRatio), this.bindEvents(), this.notifyPlugins("afterInit"), this;
	}
	clear() {
		return Yt(this.canvas, this.ctx), this;
	}
	stop() {
		return Pr.stop(this), this;
	}
	resize(e, t) {
		Pr.running(this) ? this._resizeBeforeDraw = {
			width: e,
			height: t
		} : this._resize(e, t);
	}
	_resize(e, t) {
		...
		this.width = a.width, this.height = a.height, this._aspectRatio = this.aspectRatio, cr(this, o, !0) && (this.notifyPlugins("resize", { size: a }), F(n.onResize, [this, a], this), this.attached && this._doResize(s) && this.render());
	}
	ensureScalesHaveIDs() {
		I(this.options.scales || {}, (e, t) => {
			e.id = t;
		});
	}
	buildOrUpdateScales() {
		...
		t && (i = i.concat(Object.keys(t).map((e) => {
			let n = t[e], r = oo(e, n), i = r === "r", a = r === "x";
			return {
				options: n,
			...
			let i = t.options, a = i.id, o = oo(a, i), s = P(i.type, t.dtype);
			(i.position === void 0 || wo(i.position, o) !== wo(t.dposition)) && (i.position = t.dposition), r[a] = !0;
			let c = null;
			a in n && n[a].type === s ? c = n[a] : (c = new (Y.getScale(s))({
				id: a,
				type: s,
				ctx: this.ctx,
				chart: this
	...
	_updateMetasets() {
		...
		this._sortedMetasets = e.slice(0).sort(To("order", "index"));
	}
	...
	buildOrUpdateControllers() {
		...
		for (this._removeUnreferencedMetasets(), n = 0, r = t.length; n < r; n++) {
			...
			if (i.type && i.type !== a && (this._destroyDatasetMeta(n), i = this.getDatasetMeta(n)), i.type = a, i.indexAxis = r.indexAxis || to(a, this.options), i.order = r.order || 0, i.index = n, i.label = "" + r.label, i.visible = this.isDatasetVisible(n), i.controller) i.controller.updateIndex(n), i.controller.linkScales();
			else {
				let t = Y.getController(a), { datasetElementType: r, dataElementType: o } = G.datasets[a];
				Object.assign(t, {
					dataElementType: Y.getElement(o),
					datasetElementType: r && Y.getElement(r)
	...
	update(e) {
		...
		a = this._minPadding = n.layout.autoPadding ? a : 0, this._updateLayout(a), r || I(i, (e) => {
			e.reset();
		}), this._updateDatasets(e), this.notifyPlugins("afterUpdate", { mode: e }), this._layers.sort(To("z", "_idx"));
	...
	_checkEventBindings() {
		let e = this.options;
		(!ze(new Set(Object.keys(this._listeners)), new Set(e.events)) || !!this._responsiveListeners !== e.responsive) && (this.unbindEvents(), this.bindEvents());
	}
	_updateHiddenIndices() {
		let { _hiddenIndices: e } = this, t = this._getUniformDataChanges() || [];
		for (let { method: n, start: r, count: i } of t) jo(e, r, n === "_removeElements" ? -i : i);
	}
	_getUniformDataChanges() {
		...
		for (let e = 1; e < t; e++) if (!ze(r, n(e))) return;
	...
	_updateDatasets(e) {
		if (this.notifyPlugins("beforeDatasetsUpdate", {
			...
			for (let t = 0, n = this.data.datasets.length; t < n; ++t) this._updateDataset(t, Re(e) ? e({ datasetIndex: t }) : e);
	...
	render() {
		this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 && (Pr.has(this) ? this.attached && !Pr.running(this) && Pr.start(this) : (this.draw(), Eo({ chart: this })));
	}
	draw() {
		let e;
	...
	_drawDataset(e) {
		...
		this.notifyPlugins("beforeDatasetDraw", n) !== !1 && (r && $t(t, r), e.controller.draw(), r && en(t), n.cancelable = !1, this.notifyPlugins("afterDatasetDraw", n));
	}
	isPointInArea(e) {
		return Qt(e, this.chartArea, this._minPadding);
	}
	...
	_updateVisibility(e, t, n) {
		...
		Le(t) ? (i.data[t].hidden = !n, this.update()) : (this.setDatasetVisibility(e, n), a.update(i, { visible: n }), this.update((t) => t.datasetIndex === e ? r : void 0));
	}
	hide(e, t) {
	...
	_stop() {
		let e, t;
		for (this.stop(), Pr.remove(this), e = 0, t = this.data.datasets.length; e < t; ++e) this._destroyDatasetMeta(e);
	}
	destroy() {
		this.notifyPlugins("beforeDestroy");
		let { canvas: e, ctx: t } = this;
		this._stop(), this.config.clearCache(), e && (this.unbindEvents(), Yt(e, t), this.platform.releaseContext(t), this.canvas = null, this.ctx = null), delete ko[this.id], this.notifyPlugins("afterDestroy");
	}
	toBase64Image(...e) {
	...
	unbindEvents() {
		I(this._listeners, (e, t) => {
			this.platform.removeEventListener(this, t, e);
		}), this._listeners = {}, I(this._responsiveListeners, (e, t) => {
			this.platform.removeEventListener(this, t, e);
	...
	_handleEvent(e, t, n) {
		let { _active: r = [], options: i } = this, a = t, o = this._getActiveElements(e, r, n, a), s = Be(e), c = Mo(e, this._lastEvent, n, s);
		n && (this._lastEvent = null, F(i.onHover, [
			e,
			o,
			this
		], this), s && F(i.onClick, [
...
function Po() {
	return I(No.instances, (e) => e._plugins.invalidate());
}
function Fo(e, t, n) {
	let { startAngle: r, x: i, y: a, outerRadius: o, innerRadius: s, options: c } = t, { borderWidth: l, borderJoinStyle: u } = c, d = Math.min(l / o, H(r - n));
	if (e.beginPath(), e.arc(i, a, o - l / 2, r + d / 2, n - d / 2), s > 0) {
		let t = Math.min(l / s, H(r - n));
		e.arc(i, a, s + l / 2, n - t / 2, r + t / 2, !0);
	} else {
		let t = Math.min(l / 2, o * H(r - n));
		if (u === "round") e.arc(i, a, t, n - L / 2, r + L / 2, !0);
		else if (u === "bevel") {
			let o = 2 * t * t, s = -o * Math.cos(n + L / 2) + i, c = -o * Math.sin(n + L / 2) + a, l = o * Math.cos(r + L / 2) + i, u = o * Math.sin(r + L / 2) + a;
...
function Io(e, t, n) {
	...
	e.beginPath(), e.arc(a, o, s, r - l, n + l), c > i ? (l = i / c, e.arc(a, o, c, n + l, r - l, !0)) : e.arc(a, o, i, n + z, r - z), e.closePath(), e.clip();
}
function Lo(e) {
	return pn(e, [
		"outerStart",
...
function Ro(e, t, n, r) {
	let i = Lo(e.options.borderRadius), a = (n - t) / 2, o = Math.min(a, r * t / 2), s = (e) => {
		let t = (n - Math.min(a, e)) * r / 2;
		return U(e, 0, Math.min(a, t));
	};
	return {
		outerStart: s(i.outerStart),
		outerEnd: s(i.outerEnd),
		innerStart: U(i.innerStart, 0, o),
		innerEnd: U(i.innerEnd, 0, o)
	};
}
function zo(e, t, n, r) {
	return {
...
function Bo(e, t, n, r, i, a) {
	...
	let h = (m - Math.max(.001, m * d - n / L) / d) / 2, g = c + h + p, _ = i - h - p, { outerStart: v, outerEnd: y, innerStart: b, innerEnd: x } = Ro(t, f, d, _ - g), S = d - v, C = d - y, w = g + v / S, T = _ - y / C, E = f + b, D = f + x, ee = g + b / E, O = _ - x / D;
	if (e.beginPath(), a) {
		let t = (w + T) / 2;
		if (e.arc(o, s, d, w, t), e.arc(o, s, d, t, T), y > 0) {
			let t = zo(C, T, o, s);
			e.arc(t.x, t.y, y, T, _ + z);
		}
		let n = zo(D, _, o, s);
		if (e.lineTo(n.x, n.y), x > 0) {
			let t = zo(D, O, o, s);
			e.arc(t.x, t.y, x, _ + z, O + Math.PI);
		}
		let r = (_ - x / f + (g + b / f)) / 2;
		if (e.arc(o, s, f, _ - x / f, r, !0), e.arc(o, s, f, r, g + b / f, !0), b > 0) {
			let t = zo(E, ee, o, s);
			e.arc(t.x, t.y, b, ee + Math.PI, g - z);
		}
		let i = zo(S, g, o, s);
		if (e.lineTo(i.x, i.y), v > 0) {
			let t = zo(S, w, o, s);
			e.arc(t.x, t.y, v, g - z, w);
		}
	} else {
		e.moveTo(o, s);
...
function Vo(e, t, n, r, i) {
	...
	return Bo(e, t, n, r, c, i), e.fill(), c;
}
function Ho(e, t, n, r, i) {
	...
	m && Io(e, t, h), c.selfJoin && h - o >= L && p === 0 && u !== "miter" && Fo(e, t, h), a || (Bo(e, t, n, r, h, i), e.stroke());
}
var Uo = class extends Ta {
	static id = "arc";
	static defaults = {
		borderAlign: "center",
		borderColor: "#fff",
	...
	inRange(e, t, n) {
		let { angle: r, distance: i } = nt(this.getProps(["x", "y"], n), {
			x: e,
			y: t
			...
			"outerRadius",
			"circumference"
		], n), u = (this.options.spacing + this.options.borderWidth) / 2, d = P(l, o - a), f = at(r, a, o) && a !== o, p = d >= R || f, m = st(i, s + u, c + u);
		return p && m;
	}
	getCenterPoint(e) {
	...
	draw(e) {
		...
		if (this.pixelMargin = t.borderAlign === "inner" ? .33 : 0, this.fullCircles = n > R ? Math.floor(n / R) : 0, n === 0 || this.innerRadius < 0 || this.outerRadius < 0) return;
		e.save();
		let o = (this.startAngle + this.endAngle) / 2;
		e.translate(Math.cos(o) * r, Math.sin(o) * r);
		let s = r * (1 - Math.sin(Math.min(L, n || 0)));
		e.fillStyle = t.backgroundColor, e.strokeStyle = t.borderColor, Vo(e, this, s, i, a), Ho(e, this, s, i, a), e.restore();
	}
};
function Wo(e, t, n = t) {
	e.lineCap = P(n.borderCapStyle, t.borderCapStyle), e.setLineDash(P(n.borderDash, t.borderDash)), e.lineDashOffset = P(n.borderDashOffset, t.borderDashOffset), e.lineJoin = P(n.borderJoinStyle, t.borderJoinStyle), e.lineWidth = P(n.borderWidth, t.borderWidth), e.strokeStyle = P(n.borderColor, t.borderColor);
}
function Go(e, t, n) {
	e.lineTo(n.x, n.y);
}
function Ko(e) {
	return e.stepped ? tn : e.tension || e.cubicInterpolationMode === "monotone" ? nn : Go;
}
function qo(e, t, n = {}) {
...
function Jo(e, t, n, r) {
	let { points: i, options: a } = t, { count: o, start: s, loop: c, ilen: l } = qo(i, n, r), u = Ko(a), { move: d = !0, reverse: f } = r || {}, p, m, h;
...
function Yo(e, t, n, r) {
	let i = t.points, { count: a, start: o, ilen: s } = qo(i, n, r), { move: c = !0, reverse: l } = r || {}, u = 0, d = 0, f, p, m, h, g, _, v = (e) => (o + (l ? s - e : e)) % a, y = () => {
...
function Xo(e) {
	...
	return !e._decimated && !e._loop && !t.tension && t.cubicInterpolationMode !== "monotone" && !t.stepped && !n ? Yo : Jo;
}
function Zo(e) {
	return e.stepped ? fr : e.tension || e.cubicInterpolationMode === "monotone" ? pr : dr;
}
function Qo(e, t, n, r) {
	let i = t._path;
	i || (i = t._path = new Path2D(), t.path(i, n, r) && i.closePath()), Wo(e, t.options), e.stroke(i);
}
function $o(e, t, n, r) {
	let { segments: i, options: a } = t, o = Xo(t);
	for (let s of i) Wo(e, a, s.style), e.beginPath(), o(e, t, s, {
		start: n,
		end: n + r - 1
	}) && e.closePath(), e.stroke();
}
var es = typeof Path2D == "function";
function ts(e, t, n, r) {
	es && !t.options.segment ? Qo(e, t, n, r) : $o(e, t, n, r);
}
var ns = class extends Ta {
	...
	updateControlPoints(e, t) {
		...
		if ((n.tension || n.cubicInterpolationMode === "monotone") && !n.stepped && !this._pointsUpdated) {
			...
			Jn(this._points, n, e, r, t), this._pointsUpdated = !0;
		}
	}
	set points(e) {
	...
	get segments() {
		return this._segments ||= Er(this, this.options.segment);
	}
	first() {
	...
	interpolate(e, t) {
		let n = this.options, r = e[t], i = this.points, a = Cr(this, {
			property: t,
			start: r,
			end: r
		});
	...
	pathSegment(e, t, n) {
		return Xo(this)(e, this, t, n);
	}
	path(e, t, n) {
		let r = this.segments, i = Xo(this), a = this._loop;
	...
	draw(e, t, n, r) {
		let i = this.options || {};
		(this.points || []).length && i.borderWidth && (e.save(), ts(e, this, n, r), e.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0);
	}
};
function rs(e, t, n, r) {
...
var is = class extends Ta {
	...
	inXRange(e, t) {
		return rs(this, e, "x", t);
	}
	inYRange(e, t) {
		return rs(this, e, "y", t);
	}
	getCenterPoint(e) {
		let { x: t, y: n } = this.getProps(["x", "y"], e);
		return {
	...
	draw(e, t) {
		let n = this.options;
		this.skip || n.radius < .1 || !Qt(this, t, this.size(n) / 2) || (e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth, e.fillStyle = n.backgroundColor, Xt(e, n, this.x, this.y));
	}
	getRange() {
		let e = this.options || {};
...
function ss(e, t, n) {
	let r = e.options.borderWidth, i = e.borderSkipped, a = mn(r);
	return {
		t: os(i.top, a.top, 0, n),
		r: os(i.right, a.right, 0, t),
		b: os(i.bottom, a.bottom, 0, n),
		l: os(i.left, a.left, 0, t)
	};
}
function cs(e, t, n) {
	let { enableBorderRadius: r } = e.getProps(["enableBorderRadius"]), i = e.options.borderRadius, a = hn(i), o = Math.min(t, n), s = e.borderSkipped, c = r || j(i);
	return {
		topLeft: os(!c || s.top || s.left, a.topLeft, 0, o),
		topRight: os(!c || s.top || s.right, a.topRight, 0, o),
		bottomLeft: os(!c || s.bottom || s.left, a.bottomLeft, 0, o),
		bottomRight: os(!c || s.bottom || s.right, a.bottomRight, 0, o)
	};
}
function ls(e) {
	let t = as(e), n = t.right - t.left, r = t.bottom - t.top, i = ss(e, n / 2, r / 2), a = cs(e, n / 2, r / 2);
	return {
		outer: {
			x: t.left,
			y: t.top,
...
function us(e, t, n, r) {
	let i = t === null, a = n === null, o = e && !(i && a) && as(e, r);
	return o && (i || st(t, o.left, o.right)) && (a || st(n, o.top, o.bottom));
}
function ds(e) {
...
var ms = /*#__PURE__*/ Object.freeze({
	...
	BarElement: class extends Ta {
		...
		draw(e) {
			let { inflateAmount: t, options: { borderColor: n, backgroundColor: r } } = this, { inner: i, outer: a } = ls(this), o = ds(a.radius) ? cn : fs;
			e.save(), (a.w !== i.w || a.h !== i.h) && (e.beginPath(), o(e, ps(a, t, i)), e.clip(), o(e, ps(i, -t, a)), e.fillStyle = n, e.fill("evenodd")), e.beginPath(), o(e, ps(i, t)), e.fillStyle = r, e.fill(), e.restore();
		}
		inRange(e, t, n) {
	...
	"rgb(153, 102, 255)",
	"rgb(201, 203, 207)"
], gs = /* #__PURE__ */ hs.map((e) => e.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
function _s(e) {
	return hs[e % hs.length];
}
function vs(e) {
	return gs[e % gs.length];
}
function ys(e, t) {
	return e.borderColor = _s(t), e.backgroundColor = vs(t), ++t;
}
function bs(e, t) {
	return e.backgroundColor = e.data.map(() => _s(t++)), t;
}
function xs(e, t) {
	return e.backgroundColor = e.data.map(() => vs(t++)), t;
}
function Ss(e) {
	let t = 0;
	return (n, r) => {
		let i = e.getDatasetMeta(r).controller;
		i instanceof Ti ? t = bs(n, t) : i instanceof Di ? t = xs(n, t) : i && (t = ys(n, t));
	};
}
function Cs(e) {
	let t;
...
var Es = {
	...
	beforeLayout(e, t, n) {
		if (!n.enabled) return;
		let { data: { datasets: r }, options: i } = e.config, { elements: a } = i, o = Cs(r) || ws(i) || a && Cs(a) || Ts();
...
function js(e, t) {
	...
	return c && (r = U(lt(t, a.axis, o).lo, 0, n - 1)), i = l ? U(lt(t, a.axis, s).hi + 1, r, n) - r : n - r, {
		start: r,
		count: i
	};
}
var Ms = {
	...
	beforeElementsUpdate: (e, t, n) => {
		...
		e.data.datasets.forEach((t, i) => {
			...
			if (gn([o, e.options.indexAxis]) === "y" || !s.controller.supportsDecimation) return;
			let l = e.scales[s.xAxisID];
			if (l.type !== "linear" && l.type !== "time" || e.options.parsing) return;
			let { start: u, count: d } = js(s, c);
			if (d <= (n.threshold || 4 * r)) {
				ks(t);
				return;
			}
			k(a) && (t._data = c, delete t.data, Object.defineProperty(t, "data", {
				configurable: !0,
				enumerable: !0,
				get: function() {
...
function Ns(e, t, n) {
	...
	for (let e of r) {
		...
		let l = Cr(t, c);
		for (let t of l) {
			let r = Ps(n, a[t.start], a[t.end], t.loop), s = Sr(e, i, r);
			for (let e of s) o.push({
				source: e,
				target: t,
				start: { [n]: Ls(c, r, "start", Math.max) },
				end: { [n]: Ls(c, r, "end", Math.min) }
			});
		}
	}
	return o;
...
function Rs(e, t) {
	let n = [], r = !1;
	return A(e) ? (r = !0, n = e) : n = Fs(e, t), n.length ? new ns({
		points: n,
		options: { tension: 0 },
		_loop: r,
		_fullLoop: r
...
function Vs(e, t, n) {
	let r = Gs(e);
	if (j(r)) return isNaN(r.value) ? !1 : r;
	let i = parseFloat(r);
	return M(i) && Math.floor(i) === i ? Hs(r[0], t, i, n) : [
		"origin",
		"start",
		"end",
		"stack",
...
function Us(e, t) {
	let n = null;
	return e === "start" ? n = t.bottom : e === "end" ? n = t.top : j(e) ? n = t.getPixelForValue(e.value) : t.getBasePixel && (n = t.getBasePixel()), n;
}
function Ws(e, t, n) {
	let r;
	return r = e === "start" ? n : e === "end" ? t.options.reverse ? t.min : t.max : j(e) ? e.value : t.getBaseValue(), r;
}
function Gs(e) {
	let t = e.options, n = t.fill, r = P(n && n.target, n);
	return r === void 0 && (r = !!t.backgroundColor), r === !1 || r === null ? !1 : r === !0 ? "origin" : r;
}
function Ks(e) {
	let { scale: t, index: n, line: r } = e, i = [], a = r.segments, o = r.points, s = qs(t, n);
	s.push(Rs({
		x: null,
		y: t.bottom
	}, r));
	for (let e = 0; e < a.length; e++) {
		let t = a[e];
		for (let e = t.start; e <= t.end; e++) Js(i, o[e], s);
	}
	return new ns({
		points: i,
		options: {}
...
function Js(e, t, n) {
	...
	for (let i = 0; i < n.length; i++) {
		let a = n[i], { first: o, last: s, point: c } = Ys(a, t, "x");
		if (!(!c || o && s)) {
			if (o) r.unshift(c);
...
function Zs(e) {
	...
	if (M(n)) return Qs(t, n);
	if (n === "stack") return Ks(e);
	if (n === "shape") return !0;
	let i = $s(e);
	return i instanceof Xs ? i : Rs(i, r);
}
function Qs(e, t) {
...
function $s(e) {
	return (e.scale || {}).getPointPositionForValue ? tc(e) : ec(e);
}
function ec(e) {
	let { scale: t = {}, fill: n } = e, r = Us(n, t);
	if (M(r)) {
...
function tc(e) {
	let { scale: t, fill: n } = e, r = t.options, i = t.getLabels().length, a = r.reverse ? t.max : t.min, o = Ws(n, t, a), s = [];
	if (r.grid.circular) {
...
function nc(e, t, n) {
	let r = Zs(t), { chart: i, index: a, line: o, scale: s, axis: c } = t, l = o.options, u = l.fill, d = l.backgroundColor, { above: f = d, below: p = d } = u || {}, m = Nr(i, i.getDatasetMeta(a));
	r && o.points.length && ($t(e, n), rc(e, {
		line: o,
		target: r,
		above: f,
		below: p,
...
function rc(e, t) {
	...
	a !== i && (l === "x" ? (ic(e, r, o.top), oc(e, {
		...
		property: l,
		clip: c
	}), e.restore(), e.save(), ic(e, r, o.bottom)) : l === "y" && (ac(e, r, o.left), oc(e, {
		line: n,
		target: r,
		color: a,
		scale: s,
		property: l,
		clip: c
	}), e.restore(), e.save(), ac(e, r, o.right), u = i)), oc(e, {
		line: n,
		target: r,
		color: u,
		scale: s,
...
function ic(e, t, n) {
	...
	e.beginPath();
	for (let s of r) {
		let { start: r, end: c } = s, l = i[r], u = i[Is(r, c, i)];
...
function oc(e, t) {
	let { line: n, target: r, property: i, color: a, scale: o, clip: s } = t, c = Ns(n, r, i);
	for (let { source: t, target: l, start: u, end: d } of c) {
		let { style: { backgroundColor: c = a } = {} } = t, f = r !== !0;
		e.save(), e.fillStyle = c, sc(e, o, s, f && Ps(i, u, d)), e.beginPath();
		let p = !!n.pathSegment(e, t), m;
		if (f) {
			p ? e.closePath() : cc(e, r, d, i);
...
var lc = {
	...
	afterDatasetsUpdate(e, t, n) {
		...
		for (o = 0; o < r; ++o) a = e.getDatasetMeta(o), s = a.dataset, c = null, s && s.options && s instanceof ns && (c = {
		...
		for (o = 0; o < r; ++o) c = i[o], !(!c || c.fill === !1) && (c.fill = Bs(i, o, n.propagate));
	},
	beforeDraw(e, t, n) {
		let r = n.drawTime === "beforeDraw", i = e.getSortedVisibleDatasetMetas(), a = e.chartArea;
		for (let t = i.length - 1; t >= 0; --t) {
			let n = i[t].$filler;
			n && (n.line.updateControlPoints(a, n.axis), r && n.fill && nc(e.ctx, n, a));
		}
	},
	beforeDatasetsDraw(e, t, n) {
		...
		for (let t = r.length - 1; t >= 0; --t) {
			let n = r[t].$filler;
			zs(n) && nc(e.ctx, n, e.chartArea);
		}
	},
	beforeDatasetDraw(e, t, n) {
		let r = t.meta.$filler;
		!zs(r) || n.drawTime !== "beforeDatasetDraw" || nc(e.ctx, r, e.chartArea);
	},
	defaults: {
		propagate: !0,
...
}, dc = (e, t) => e !== null && t !== null && e.datasetIndex === t.datasetIndex && e.index === t.index, fc = class extends Ta {
	constructor(e) {
	...
	buildLabels() {
		let e = this.options.labels || {}, t = F(e.generateLabels, [this.chart], this) || [];
	...
	fit() {
		...
		let n = e.labels, r = q(n.font), i = r.size, a = this._computeTitleHeight(), { boxWidth: o, itemHeight: s } = uc(n, i), c, l;
	...
	_fitCols(e, t, n, r) {
		...
		return this.legendItems.forEach((e, a) => {
			let { itemWidth: h, itemHeight: g } = pc(n, t, i, e, r);
	...
	adjustHitBoxes() {
		...
		let e = this._computeTitleHeight(), { legendHitBoxes: t, options: { align: n, labels: { padding: r }, rtl: i } } = this, a = gr(i, this.left, this.width);
		if (this.isHorizontal()) {
			let i = 0, o = W(n, this.left + r, this.right - this.lineWidths[i]);
			for (let s of t) i !== s.row && (i = s.row, o = W(n, this.left + r, this.right - this.lineWidths[i])), s.top += this.top + e + r, s.left = a.leftForLtr(a.x(o), s.width), o += s.width + r;
		} else {
			let i = 0, o = W(n, this.top + e + r, this.bottom - this.columnSizes[i].height);
			for (let s of t) s.col !== i && (i = s.col, o = W(n, this.top + e + r, this.bottom - this.columnSizes[i].height)), s.top = o, s.left += this.left + r, s.left = a.leftForLtr(a.x(s.left), s.width), o += s.height + r;
		}
	}
	isHorizontal() {
	...
	draw() {
		if (this.options.display) {
			let e = this.ctx;
			$t(e, this), this._draw(), en(e);
		}
	}
	_draw() {
		let { options: e, columnSizes: t, lineWidths: n, ctx: r } = this, { align: i, labels: a } = e, o = G.color, s = gr(e.rtl, this.left, this.width), c = q(a.font), { padding: l } = a, u = c.size, d = u / 2, f;
		this.drawTitle(), r.textAlign = s.textAlign("left"), r.textBaseline = "middle", r.lineWidth = .5, r.font = c.string;
		let { boxWidth: p, boxHeight: m, itemHeight: h } = uc(a, u), g = function(e, t, n) {
			if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return;
			r.save();
			let i = P(n.lineWidth, 1);
			if (r.fillStyle = P(n.fillStyle, o), r.lineCap = P(n.lineCap, "butt"), r.lineDashOffset = P(n.lineDashOffset, 0), r.lineJoin = P(n.lineJoin, "miter"), r.lineWidth = i, r.strokeStyle = P(n.strokeStyle, o), r.setLineDash(P(n.lineDash, [])), a.usePointStyle) Zt(r, {
				...
				let a = t + Math.max((u - m) / 2, 0), o = s.leftForLtr(e, p), c = hn(n.borderRadius);
			...
			sn(r, n.text, e, t + h / 2, c, {
				strikethrough: n.hidden,
				textAlign: s.textAlign(n.textAlign)
			});
		}, v = this.isHorizontal(), y = this._computeTitleHeight();
		f = v ? {
			x: W(i, this.left + l, this.right - n[0]),
			y: this.top + l + y,
			line: 0
		} : {
			x: this.left + l,
			y: W(i, this.top + y + l, this.bottom - t[0].height),
			line: 0
		}, _r(this.ctx, e.textDirection);
		let b = h + l;
		this.legendItems.forEach((o, u) => {
			...
			if (s.setWidth(this.width), v ? u > 0 && S + x + l > this.right && (C = f.y += b, f.line++, S = f.x = W(i, this.left + l, this.right - n[f.line])) : u > 0 && C + b > this.bottom && (S = f.x = S + t[f.line].width + l, f.line++, C = f.y = W(i, this.top + y + l, this.bottom - t[f.line].height)), g(s.x(S), C, o), S = bt(h, S + p + d, v ? S + x : this.right, e.rtl), _(s.x(S), C, o), v) f.x += x + l;
			else if (typeof o.text != "string") {
				let e = c.lineHeight;
				f.y += gc(o, e) + l;
			} else f.y += b;
		}), vr(this.ctx, e.textDirection);
	}
	drawTitle() {
		let e = this.options, t = e.title, n = q(t.font), r = K(t.padding);
		if (!t.display) return;
		let i = gr(e.rtl, this.left, this.width), a = this.ctx, o = t.position, s = n.size / 2, c = r.top + s, l, u = this.left, d = this.width;
		if (this.isHorizontal()) d = Math.max(...this.lineWidths), l = this.top + c, u = W(e.align, u, this.right - d);
		else {
			let t = this.columnSizes.reduce((e, t) => Math.max(e, t.height), 0);
			l = c + W(e.align, this.top, this.bottom - t - e.labels.padding - this._computeTitleHeight());
		}
		let f = W(o, u, u + d);
		a.textAlign = i.textAlign(yt(o)), a.textBaseline = "middle", a.strokeStyle = t.color, a.fillStyle = t.color, a.font = n.string, sn(a, t.text, f, l, n);
	}
	_computeTitleHeight() {
		let e = this.options.title, t = q(e.font), n = K(e.padding);
		return e.display ? t.lineHeight + n.height : 0;
	}
	_getLegendItemAt(e, t) {
		let n, r, i;
		if (st(e, this.left, this.right) && st(t, this.top, this.bottom)) {
			for (i = this.legendHitBoxes, n = 0; n < i.length; ++n) if (r = i[n], st(e, r.left, r.left + r.width) && st(t, r.top, r.top + r.height)) return this.legendItems[n];
		}
		return null;
	}
	handleEvent(e) {
		let t = this.options;
		if (!_c(e.type, t)) return;
		let n = this._getLegendItemAt(e.x, e.y);
		if (e.type === "mousemove" || e.type === "mouseout") {
			let r = this._hoveredItem, i = dc(r, n);
			r && !i && F(t.onLeave, [
				e,
				r,
				this
			], this), this._hoveredItem = n, n && !i && F(t.onHover, [
				e,
				n,
				this
			], this);
...
function pc(e, t, n, r, i) {
	return {
		itemWidth: mc(r, e, t, n),
		itemHeight: hc(i, r, t.lineHeight)
	};
}
function mc(e, t, n, r) {
	let i = e.text;
...
function hc(e, t, n) {
	let r = e;
	return typeof t.text != "string" && (r = gc(t, n)), r;
}
function gc(e, t) {
...
var vc = {
		...
		labels: {
			...
			generateLabels(e) {
				...
				return e._getSortedDatasetMetas().map((e) => {
					let c = e.controller.getStyle(n ? 0 : void 0), l = K(c.borderWidth);
					return {
	...
	update(e, t) {
		...
		let r = A(n.text) ? n.text.length : 1;
		this._padding = K(n.padding);
		let i = r * q(n.font).lineHeight + this._padding.height;
	...
	_drawArgs(e) {
		...
		return this.isHorizontal() ? (l = W(o, n, i), u = t + e, c = i - n) : (a.position === "left" ? (l = n + e, u = W(o, r, t), s = L * -.5) : (l = i - e, u = W(o, t, r), s = L * .5), c = r - t), {
			titleX: l,
			titleY: u,
			maxWidth: c,
			rotation: s
	...
	draw() {
		...
		if (!t.display) return;
		let n = q(t.font), r = n.lineHeight / 2 + this._padding.top, { titleX: i, titleY: a, maxWidth: o, rotation: s } = this._drawArgs(r);
		sn(e, t.text, 0, 0, n, {
			color: t.color,
			maxWidth: o,
			rotation: s,
...
var xc = {
	...
	start(e, t, n) {
		...
		J.configure(e, r, n), J.addBox(e, r), Sc.set(e, r);
	},
	stop(e) {
		J.removeBox(e, Sc.get(e)), Sc.delete(e);
	},
	beforeUpdate(e, t, n) {
		let r = Sc.get(e);
		J.configure(e, r, n), r.options = n;
...
function X(e, t) {
	return t && (A(t) ? Array.prototype.push.apply(e, t) : e.push(t)), e;
}
function Tc(e) {
...
function Dc(e, t) {
	let n = e.chart.ctx, { body: r, footer: i, title: a } = e, { boxWidth: o, boxHeight: s } = t, c = q(t.bodyFont), l = q(t.titleFont), u = q(t.footerFont), d = a.length, f = i.length, p = r.length, m = K(t.padding), h = m.height, g = 0, _ = r.reduce((e, t) => e + t.before.length + t.lines.length + t.after.length, 0);
	...
	return n.save(), n.font = l.string, I(e.title, y), n.font = c.string, I(e.beforeBody.concat(e.afterBody), y), v = t.displayColors ? o + 2 + t.boxPadding : 0, I(r, (e) => {
		I(e.before, y), I(e.lines, y), I(e.after, y);
	}), v = 0, n.font = u.string, I(e.footer, y), n.restore(), g += m.width, {
		width: g,
		height: h
	};
}
...
function Ac(e, t, n, r) {
	...
	return r === "center" ? l = i <= (s + c) / 2 ? "left" : "right" : i <= a / 2 ? l = "left" : i >= o - a / 2 && (l = "right"), kc(l, e, t, n) && (l = "center"), l;
}
function jc(e, t, n) {
	let r = n.yAlign || t.yAlign || Oc(e, n);
	return {
		xAlign: n.xAlign || t.xAlign || Ac(e, t, n, r),
		yAlign: r
	};
}
function Mc(e, t) {
...
function Pc(e, t, n, r) {
	let { caretSize: i, caretPadding: a, cornerRadius: o } = e, { xAlign: s, yAlign: c } = n, l = i + a, { topLeft: u, topRight: d, bottomLeft: f, bottomRight: p } = hn(o), m = Mc(t, s), h = Nc(t, c, l);
	return c === "center" ? s === "left" ? m += l : s === "right" && (m -= l) : s === "left" ? m -= Math.max(u, f) + i : s === "right" && (m += Math.max(d, p) + i), {
		x: U(m, 0, r.width - t.width),
		y: U(h, 0, r.height - t.height)
	};
}
function Fc(e, t, n) {
	let r = K(n.padding);
...
function Z(e, t, n, r) {
	let i = e[t].call(n, r);
	return i === void 0 ? zc[t].call(n, r) : i;
}
var Bc = class extends Ta {
	static positioners = wc;
	constructor(e) {
	...
	_resolveAnimations() {
		...
		if (e) return e;
		let t = this.chart, n = this.options.setContext(this.getContext()), r = n.enabled && t.options.animation && n.animations, i = new Rr(this.chart, r);
		return r._cacheable && (this._cachedAnimations = Object.freeze(i)), i;
	}
	getContext() {
		return this.$context ||= Lc(this.chart.getContext(), this, this._tooltipItems);
	}
	getTitle(e, t) {
		let { callbacks: n } = t, r = Z(n, "beforeTitle", this, e), i = Z(n, "title", this, e), a = Z(n, "afterTitle", this, e), o = [];
		return o = X(o, Tc(r)), o = X(o, Tc(i)), o = X(o, Tc(a)), o;
	}
	getBeforeBody(e, t) {
		return Ic(Z(t.callbacks, "beforeBody", this, e));
	}
	getBody(e, t) {
		let { callbacks: n } = t, r = [];
		return I(e, (e) => {
			...
			X(t.before, Tc(Z(i, "beforeLabel", this, e))), X(t.lines, Z(i, "label", this, e)), X(t.after, Tc(Z(i, "afterLabel", this, e))), r.push(t);
		}), r;
	}
	getAfterBody(e, t) {
		return Ic(Z(t.callbacks, "afterBody", this, e));
	}
	getFooter(e, t) {
		let { callbacks: n } = t, r = Z(n, "beforeFooter", this, e), i = Z(n, "footer", this, e), a = Z(n, "afterFooter", this, e), o = [];
		return o = X(o, Tc(r)), o = X(o, Tc(i)), o = X(o, Tc(a)), o;
	}
	_createItems(e) {
		let t = this._active, n = this.chart.data, r = [], i = [], a = [], o = [], s, c;
		for (s = 0, c = t.length; s < c; ++s) o.push(Ec(this.chart, t[s]));
		return e.filter && (o = o.filter((t, r, i) => e.filter(t, r, i, n))), e.itemSort && (o = o.sort((t, r) => e.itemSort(t, r, n))), I(o, (t) => {
			let n = Rc(e.callbacks, t);
			r.push(Z(n, "labelColor", this, t)), i.push(Z(n, "labelPointStyle", this, t)), a.push(Z(n, "labelTextColor", this, t));
	...
	update(e, t) {
		...
		if (!r.length) this.opacity !== 0 && (i = { opacity: 0 });
			...
			let e = wc[n.position].call(this, r, this._eventPosition);
			...
			let t = this._size = Dc(this, n), o = Object.assign({}, e, t), s = jc(this.chart, n, o), c = Pc(n, o, s, this.chart);
	...
	getCaretPosition(e, t, n) {
		let { xAlign: r, yAlign: i } = this, { caretSize: a, cornerRadius: o } = n, { topLeft: s, topRight: c, bottomLeft: l, bottomRight: u } = hn(o), { x: d, y: f } = e, { width: p, height: m } = t, h, g, _, v, y, b;
	...
	drawTitle(e, t, n) {
		...
		if (i) {
			let c = gr(n.rtl, this.x, this.width);
			for (e.x = Fc(this, n.titleAlign, n), t.textAlign = c.textAlign(n.titleAlign), t.textBaseline = "middle", a = q(n.titleFont), o = n.titleSpacing, t.fillStyle = n.titleColor, t.font = a.string, s = 0; s < i; ++s) t.fillText(r[s], c.x(e.x), e.y + a.lineHeight / 2), e.y += a.lineHeight + o, s + 1 === i && (e.y += n.titleMarginBottom - o);
		}
	}
	_drawColorBox(e, t, n, r, i) {
		let a = this.labelColors[n], o = this.labelPointStyles[n], { boxHeight: s, boxWidth: c } = i, l = q(i.bodyFont), u = Fc(this, "left", i), d = r.x(u), f = s < l.lineHeight ? (l.lineHeight - s) / 2 : 0, p = t.y + f;
		if (i.usePointStyle) {
			let t = {
			...
			e.strokeStyle = i.multiKeyBackground, e.fillStyle = i.multiKeyBackground, Xt(e, t, n, l), e.strokeStyle = a.borderColor, e.fillStyle = a.backgroundColor, Xt(e, t, n, l);
		} else {
			e.lineWidth = j(a.borderWidth) ? Math.max(...Object.values(a.borderWidth)) : a.borderWidth || 1, e.strokeStyle = a.borderColor, e.setLineDash(a.borderDash || []), e.lineDashOffset = a.borderDashOffset || 0;
			let t = r.leftForLtr(d, c), n = r.leftForLtr(r.xPlus(d, 1), c - 2), o = hn(a.borderRadius);
			Object.values(o).some((e) => e !== 0) ? (e.beginPath(), e.fillStyle = i.multiKeyBackground, cn(e, {
				x: t,
				y: p,
				w: c,
				h: s,
				radius: o
			}), e.fill(), e.stroke(), e.fillStyle = a.backgroundColor, e.beginPath(), cn(e, {
				x: n,
				y: p + 1,
				w: c - 2,
				h: s - 2,
	...
	drawBody(e, t, n) {
		let { body: r } = this, { bodySpacing: i, bodyAlign: a, displayColors: o, boxHeight: s, boxWidth: c, boxPadding: l } = n, u = q(n.bodyFont), d = u.lineHeight, f = 0, p = gr(n.rtl, this.x, this.width), m = function(n) {
			t.fillText(n, p.x(e.x + f), e.y + d / 2), e.y += d + i;
		}, h = p.textAlign(a), g, _, v, y, b, x, S;
		for (t.textAlign = a, t.textBaseline = "middle", t.font = u.string, e.x = Fc(this, h, n), t.fillStyle = n.bodyColor, I(this.beforeBody, m), f = o && h !== "right" ? a === "center" ? c / 2 + l : c + 2 + l : 0, y = 0, x = r.length; y < x; ++y) {
			for (g = r[y], _ = this.labelTextColors[y], t.fillStyle = _, I(g.before, m), v = g.lines, o && v.length && (this._drawColorBox(t, e, y, p, n), d = Math.max(u.lineHeight, s)), b = 0, S = v.length; b < S; ++b) m(v[b]), d = u.lineHeight;
			I(g.after, m);
		}
		f = 0, d = u.lineHeight, I(this.afterBody, m), e.y -= i;
	}
	drawFooter(e, t, n) {
		let r = this.footer, i = r.length, a, o;
		if (i) {
			let s = gr(n.rtl, this.x, this.width);
			for (e.x = Fc(this, n.footerAlign, n), e.y += n.footerMarginTop, t.textAlign = s.textAlign(n.footerAlign), t.textBaseline = "middle", a = q(n.footerFont), t.fillStyle = n.footerColor, t.font = a.string, o = 0; o < i; ++o) t.fillText(r[o], s.x(e.x), e.y + a.lineHeight / 2), e.y += a.lineHeight + n.footerSpacing;
		}
	}
	drawBackground(e, t, n, r) {
		let { xAlign: i, yAlign: a } = this, { x: o, y: s } = e, { width: c, height: l } = n, { topLeft: u, topRight: d, bottomLeft: f, bottomRight: p } = hn(r.cornerRadius);
	...
	_updateAnimationTarget(e) {
		...
		if (r || i) {
			let n = wc[e.position].call(this, this._active, this._eventPosition);
			if (!n) return;
			let a = this._size = Dc(this, e), o = Object.assign({}, n, this._size), s = jc(t, e, o), c = Pc(e, o, s, t);
	...
	draw(e) {
		...
		let a = K(t.padding), o = this.title.length || this.beforeBody.length || this.body.length || this.afterBody.length || this.footer.length;
		t.enabled && o && (e.save(), e.globalAlpha = n, this.drawBackground(i, e, r, t), _r(e, t.textDirection), i.y += a.top, this.drawTitle(i, e, t), this.drawBody(i, e, t), this.drawFooter(i, e, t), vr(e, t.textDirection), e.restore());
	}
	getActiveElements() {
		return this._active || [];
	}
	setActiveElements(e, t) {
		...
		}), i = !Te(n, r), a = this._positionChanged(r, t);
	...
	handleEvent(e, t, n = !0) {
		...
		let r = this.options, i = this._active || [], a = this._getActiveElements(e, i, t, n), o = this._positionChanged(a, e), s = t || !Te(a, i) || o;
	...
	_positionChanged(e, t) {
		let { caretX: n, caretY: r, options: i } = this, a = wc[i.position].call(this, e, t);
		return a !== !1 && (n !== a.x || r !== a.y);
	}
}, Vc = /*#__PURE__*/ Object.freeze({
	__proto__: null,
	Colors: Es,
	Decimation: Ms,
	Filler: lc,
...
}), Hc = (e, t, n, r) => (typeof t == "string" ? (n = e.push(t) - 1, r.unshift({
	index: n,
	label: t
})) : isNaN(t) && (n = null), n);
function Uc(e, t, n, r) {
	let i = e.indexOf(t);
	return i === -1 ? Hc(e, t, n, r) : i === e.lastIndexOf(t) ? i : n;
}
var Wc = (e, t) => e === null ? null : U(Math.round(e), 0, t);
function Gc(e) {
	let t = this.getLabels();
	return e >= 0 && e < t.length ? t[e] : e;
}
var Kc = class extends Ga {
	static id = "category";
	static defaults = { ticks: { callback: Gc } };
	constructor(e) {
	...
	parse(e, t) {
		...
		return t = isFinite(t) && n[t] === e ? t : Uc(n, e, P(t, e), this._addedLabels), Wc(t, n.length - 1);
	}
	determineDataLimits() {
...
function qc(e, t) {
	let n = [], { bounds: r, step: i, min: a, max: o, precision: s, count: c, maxTicks: l, maxDigits: u, includeBounds: d } = e, f = i || 1, p = l - 1, { min: m, max: h } = t, g = !k(a), _ = !k(o), v = !k(c), y = (h - m) / (u + 1), b = Je((h - m) / p / f) * f, x, S, C, w;
	if (b < 1e-14 && !g && !_) return [{ value: m }, { value: h }];
	w = Math.ceil(h / b) - Math.floor(m / b), w > p && (b = Je(w * b / p / f) * f), k(s) || (x = 10 ** s, b = Math.ceil(b * x) / x), r === "ticks" ? (S = Math.floor(m / b) * b, C = Math.ceil(h / b) * b) : (S = m, C = h), g && _ && i && Qe((o - a) / i, b / 1e3) ? (w = Math.round(Math.min((o - a) / b, l)), b = (o - a) / w, S = a, C = o) : v ? (S = g ? a : S, C = _ ? o : C, w = c - 1, b = (C - S) / w) : (w = (C - S) / b, w = qe(w, Math.round(w), b / 1e3) ? Math.round(w) : Math.ceil(w));
	let T = Math.max(tt(b), tt(S));
	x = 10 ** (k(s) ? T : s), S = Math.round(S * x) / x, C = Math.round(C * x) / x;
	let E = 0;
	for (g && (d && S !== a ? (n.push({ value: a }), S < a && E++, qe(Math.round((S + E * b) * x) / x, a, Jc(a, y, e)) && E++) : S < a && E++); E < w; ++E) {
		let e = Math.round((S + E * b) * x) / x;
		if (_ && e > o) break;
		n.push({ value: e });
	}
	return _ && d && C !== o ? n.length && qe(n[n.length - 1].value, o, Jc(o, y, e)) ? n[n.length - 1].value = o : n.push({ value: o }) : (!_ || C === o) && n.push({ value: C }), n;
}
function Jc(e, t, { horizontal: n, minRotation: r }) {
	let i = V(r), a = (n ? Math.sin(i) : Math.cos(i)) || .001, o = .75 * t * ("" + e).length;
	return Math.min(t / a, o);
}
var Yc = class extends Ga {
	constructor(e) {
	...
	buildTicks() {
		...
		return e.bounds === "ticks" && $e(r, this, "value"), e.reverse ? (r.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), r;
	}
	configure() {
	...
	getLabelForValue(e) {
		return It(e, this.chart.options.locale, this.options.ticks.format);
	}
}, Xc = class extends Yc {
	static id = "linear";
	...
	determineDataLimits() {
		...
		this.min = M(e) ? e : 0, this.max = M(t) ? t : 1, this.handleTickRangeOptions();
	}
	computeTickLimit() {
		let e = this.isHorizontal(), t = e ? this.width : this.height, n = V(this.options.ticks.minRotation), r = (e ? Math.sin(n) : Math.cos(n)) || .001, i = this._resolveTickFontOptions(0);
...
}, Zc = (e) => Math.floor(Ke(e)), Qc = (e, t) => 10 ** (Zc(e) + t);
function $c(e) {
	return e / 10 ** Zc(e) == 1;
}
function el(e, t, n) {
...
function tl(e, t) {
	...
	for (; el(e, t, n) > 10;) n++;
	for (; el(e, t, n) < 10;) n--;
	return Math.min(n, Zc(e));
}
function nl(e, { min: t, max: n }) {
	t = N(e.min, t);
	let r = [], i = Zc(t), a = tl(t, n), o = a < 0 ? 10 ** Math.abs(a) : 1, s = 10 ** a, c = i > a ? 10 ** i : 0, l = Math.round((t - c) * o) / o, u = Math.floor((t - c) / s / 10) * s * 10, d = Math.floor((l - u) / 10 ** a), f = N(e.min, Math.round((c + u + d * 10 ** a) * o) / o);
	for (; f < n;) r.push({
		value: f,
		major: $c(f),
		significand: d
...
var rl = class extends Ga {
	...
	parse(e, t) {
		let n = Yc.prototype.parse.apply(this, [e, t]);
		if (n === 0) {
			this._zero = !0;
			return;
		}
		return M(n) && n > 0 ? n : null;
	}
	determineDataLimits() {
		let { min: e, max: t } = this.getMinMax(!0);
		this.min = M(e) ? Math.max(0, e) : null, this.max = M(t) ? Math.max(0, t) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !M(this._userMin) && (this.min = e === Qc(this.min, 0) ? Qc(this.min, -1) : Qc(this.min, 0)), this.handleTickRangeOptions();
	}
	handleTickRangeOptions() {
		let { minDefined: e, maxDefined: t } = this.getUserBounds(), n = this.min, r = this.max, i = (t) => n = e ? n : t, a = (e) => r = t ? r : e;
		n === r && (n <= 0 ? (i(1), a(10)) : (i(Qc(n, -1)), a(Qc(r, 1)))), n <= 0 && i(Qc(r, -1)), r <= 0 && a(Qc(n, 1)), this.min = n, this.max = r;
	}
	buildTicks() {
		let e = this.options, t = nl({
			min: this._userMin,
			max: this._userMax
		}, this);
		return e.bounds === "ticks" && $e(t, this, "value"), e.reverse ? (t.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), t;
	}
	getLabelForValue(e) {
		return e === void 0 ? "0" : It(e, this.chart.options.locale, this.options.ticks.format);
	}
	configure() {
		let e = this.min;
		super.configure(), this._startValue = Ke(e), this._valueRange = Ke(this.max) - Ke(e);
	}
	getPixelForValue(e) {
		return (e === void 0 || e === 0) && (e = this.min), e === null || isNaN(e) ? NaN : this.getPixelForDecimal(e === this.min ? 0 : (Ke(e) - this._startValue) / this._valueRange);
	}
	getValueForPixel(e) {
...
function il(e) {
	...
	if (t.display && e.display) {
		let e = K(t.backdropPadding);
		return P(t.font && t.font.size, G.font.size) + e.height;
	}
	return 0;
}
function al(e, t, n) {
...
function sl(e) {
	...
	}, n = Object.assign({}, t), r = [], i = [], a = e._pointLabels.length, o = e.options.pointLabels, s = o.centerPointLabels ? L / a : 0;
	for (let c = 0; c < a; c++) {
		let a = o.setContext(e.getPointLabelContext(c));
		i[c] = a.padding;
		let l = e.getPointPosition(c, e.drawingArea + i[c], s), u = q(a.font), d = al(e.ctx, u, e._pointLabels[c]);
		r[c] = d;
		let f = H(e.getIndexAngle(c) + s), p = Math.round(et(f));
		cl(n, t, f, ol(p, l.x, d.w, 0, 180), ol(p, l.y, d.h, 90, 270));
	}
	e.setCenterPoint(t.l - n.l, n.r - t.r, t.t - n.t, n.b - t.b), e._pointLabelItems = dl(e, r, i);
}
...
function ll(e, t, n) {
	let r = e.drawingArea, { extra: i, additionalAngle: a, padding: o, size: s } = n, c = e.getPointPosition(t, r + i + o, a), l = Math.round(et(H(c.angle + z))), u = ml(c.y, s.h, l), d = fl(l), f = pl(c.x, s.w, d);
	return {
		visible: !0,
		x: c.x,
		y: u,
...
function dl(e, t, n) {
	let r = [], i = e._pointLabels.length, a = e.options, { centerPointLabels: o, display: s } = a.pointLabels, c = {
		extra: il(a) / 2,
		additionalAngle: o ? L / i : 0
	}, l;
	for (let a = 0; a < i; a++) {
		c.padding = n[a], c.size = t[a];
		let i = ll(e, a, c);
		r.push(i), s === "auto" && (i.visible = ul(i, l), i.visible && (l = i));
	}
	return r;
}
function fl(e) {
...
function hl(e, t, n) {
	...
	if (!k(s)) {
		let n = hn(t.borderRadius), c = K(t.backdropPadding);
		e.fillStyle = s;
		let l = r - c.left, u = i - c.top, d = a - r + c.width, f = o - i + c.height;
		Object.values(n).some((e) => e !== 0) ? (e.beginPath(), cn(e, {
			x: l,
			y: u,
			w: d,
			h: f,
...
function gl(e, t) {
	...
	for (let i = t - 1; i >= 0; i--) {
		...
		hl(n, a, t);
		let o = q(a.font), { x: s, y: c, textAlign: l } = t;
		sn(n, e._pointLabels[i], s, c + o.lineHeight / 2, o, {
			color: a.color,
			textAlign: l,
			textBaseline: "middle"
		});
...
function _l(e, t, n, r) {
	let { ctx: i } = e;
	if (n) i.arc(e.xCenter, e.yCenter, t, 0, R);
	else {
...
function vl(e, t, n, r, i) {
	...
	!o && !r || !s || !c || n < 0 || (a.save(), a.strokeStyle = s, a.lineWidth = c, a.setLineDash(i.dash || []), a.lineDashOffset = i.dashOffset, a.beginPath(), _l(e, n, o, r), a.closePath(), a.stroke(), a.restore());
}
function yl(e, t, n) {
	return vn(e, {
		label: n,
...
var bl = class extends Yc {
	...
	setDimensions() {
		let e = this._padding = K(il(this.options) / 2), t = this.width = this.maxWidth - e.width, n = this.height = this.maxHeight - e.height;
	...
	determineDataLimits() {
		...
		this.min = M(e) && !isNaN(e) ? e : 0, this.max = M(t) && !isNaN(t) ? t : 0, this.handleTickRangeOptions();
	}
	computeTickLimit() {
		return Math.ceil(this.drawingArea / il(this.options));
	}
	generateTickLabels(e) {
		Yc.prototype.generateTickLabels.call(this, e), this._pointLabels = this.getLabels().map((e, t) => {
			let n = F(this.options.pointLabels.callback, [e, t], this);
			return n || n === 0 ? n : "";
		}).filter((e, t) => this.chart.getDataVisibility(t));
	}
	fit() {
		let e = this.options;
		e.display && e.pointLabels.display ? sl(this) : this.setCenterPoint(0, 0, 0, 0);
	}
	...
	getIndexAngle(e) {
		let t = R / (this._pointLabels.length || 1), n = this.options.startAngle || 0;
		return H(e * t + V(n));
	}
	...
	getPointLabelContext(e) {
		...
		if (e >= 0 && e < t.length) {
			let n = t[e];
			return yl(this.getContext(), e, n);
		}
	}
	getPointPosition(e, t, n = 0) {
		let r = this.getIndexAngle(e) - z + n;
		return {
	...
	drawBackground() {
		...
		if (e) {
			let n = this.ctx;
			n.save(), n.beginPath(), _l(this, this.getDistanceFromCenterForValue(this._endValue), t, this._pointLabels.length), n.closePath(), n.fillStyle = e, n.fill(), n.restore();
		}
	}
	drawGrid() {
		let e = this.ctx, t = this.options, { angleLines: n, grid: r, border: i } = t, a = this._pointLabels.length, o, s, c;
		if (t.pointLabels.display && gl(this, a), r.display && this.ticks.forEach((e, t) => {
	...
	drawLabels() {
		...
		e.save(), e.translate(this.xCenter, this.yCenter), e.rotate(r), e.textAlign = "center", e.textBaseline = "middle", this.ticks.forEach((r, o) => {
			...
			let s = n.setContext(this.getContext(o)), c = q(s.font);
...
function Cl(e, t) {
	...
	return typeof r == "function" && (o = r(o)), M(o) || (o = typeof r == "string" ? n.parse(o, r) : n.parse(o)), o === null ? null : (i && (o = i === "week" && (Ze(a) || a === !0) ? n.startOf(o, "isoWeek", a) : n.startOf(o, i)), +o);
}
function wl(e, t, n, r) {
	let i = Q.length;
	for (let a = Q.indexOf(e); a < i - 1; ++a) {
		let e = xl[Q[a]], i = e.steps ? e.steps : 2 ** 53 - 1;
		if (e.common && Math.ceil((n - t) / (i * e.size)) <= r) return Q[a];
	}
	return Q[i - 1];
}
function Tl(e, t, n, r, i) {
	for (let a = Q.length - 1; a >= Q.indexOf(n); a--) {
		let n = Q[a];
		if (xl[n].common && e._adapter.diff(i, r, n) >= t - 1) return n;
	}
	return Q[n ? Q.indexOf(n) : 0];
}
function El(e) {
	for (let t = Q.indexOf(e) + 1, n = Q.length; t < n; ++t) if (xl[Q[t]].common) return Q[t];
}
function Dl(e, t, n) {
	if (!n) e[t] = !0;
	else if (n.length) {
		let { lo: r, hi: i } = ct(n, t), a = n[r] >= t ? n[r] : n[i];
		e[a] = !0;
	}
}
function Ol(e, t, n, r) {
...
function kl(e, t, n) {
	...
	return a === 0 || !n ? r : Ol(e, r, i, n);
}
var Al = class extends Ga {
	static id = "time";
	static defaults = {
		bounds: "data",
		adapters: {},
	...
	init(e, t = {}) {
		let n = e.time ||= {}, r = this._adapter = new Ai._date(e.adapters.date);
		r.init(t), Ae(n.displayFormats, r.formats()), this._parseOpts = {
			parser: n.parser,
			round: n.round,
	...
	parse(e, t) {
		return e === void 0 ? null : Cl(this, e);
	}
	beforeLayout() {
	...
	determineDataLimits() {
		...
		(!a || !o) && (s(this._getLabelBounds()), (e.bounds !== "ticks" || e.ticks.source !== "labels") && s(this.getMinMax(!1))), r = M(r) && !isNaN(r) ? r : +t.startOf(Date.now(), n), i = M(i) && !isNaN(i) ? i : +t.endOf(Date.now(), n) + 1, this.min = Math.min(r, i - 1), this.max = Math.max(r + 1, i);
	}
	_getLabelBounds() {
	...
	buildTicks() {
		...
		let i = this.min, a = this.max, o = dt(r, i, a);
		return this._unit = t.unit || (n.autoSkip ? wl(t.minUnit, this.min, this.max, this._getLabelCapacity(i)) : Tl(this, o.length, t.minUnit, this.min, this.max)), this._majorUnit = !n.major.enabled || this._unit === "year" ? void 0 : El(this._unit), this.initOffsets(r), e.reverse && o.reverse(), kl(this, o, this._majorUnit);
	}
	afterAutoSkip() {
	...
	initOffsets(e = []) {
		...
		t = U(t, 0, a), n = U(n, 0, a), this._offsets = {
			start: t,
			end: n,
			factor: 1 / (t + 1 + n)
		};
	...
	_generate() {
		let e = this._adapter, t = this.min, n = this.max, r = this.options, i = r.time, a = i.unit || wl(i.minUnit, t, n, this._getLabelCapacity(t)), o = P(r.ticks.stepSize, 1), s = a === "week" ? i.isoWeekday : !1, c = Ze(s) || s === !0, l = {}, u = t, d, f;
		...
		for (d = u, f = 0; d < n; d = +e.add(d, o, a), f++) Dl(l, d, p);
		return (d === n || r.bounds === "ticks" || f === 1) && Dl(l, d, p), Object.keys(l).sort(Sl).map((e) => +e);
	}
	getLabelForValue(e) {
	...
	_getLabelSize(e) {
		let t = this.options.ticks, n = this.ctx.measureText(e).width, r = V(this.isHorizontal() ? t.maxRotation : t.minRotation), i = Math.cos(r), a = Math.sin(r), o = this._resolveTickFontOptions(0).size;
		return {
			w: n * i + o * a,
			h: n * a + o * i
		};
	...
	_getLabelCapacity(e) {
		let t = this.options.time, n = t.displayFormats, r = n[t.unit] || n.millisecond, i = this._tickFormatFunction(e, 0, kl(this, [e], this._majorUnit), r), a = this._getLabelSize(i), o = Math.floor(this.isHorizontal() ? this.width / a.w : this.height / a.h) - 1;
		return o > 0 ? o : 1;
	}
	getDataTimestamps() {
	...
	getLabelTimestamps() {
		...
		for (t = 0, n = r.length; t < n; ++t) e.push(Cl(this, r[t]));
...
function jl(e, t, n) {
	...
	n ? (t >= e[r].pos && t <= e[i].pos && ({lo: r, hi: i} = lt(e, "pos", t)), {pos: a, time: s} = e[r], {pos: o, time: c} = e[i]) : (t >= e[r].time && t <= e[i].time && ({lo: r, hi: i} = lt(e, "time", t)), {time: a, pos: s} = e[r], {time: o, pos: c} = e[i]);
	let l = o - a;
...
var Ml = class extends Al {
	...
	initOffsets() {
		...
		this._minPos = jl(t, this.min), this._tableRange = jl(t, this.max) - this._minPos, super.initOffsets(e);
	}
	buildLookupTable(e) {
	...
	getDecimalForValue(e) {
		return (jl(this._table, e) - this._minPos) / this._tableRange;
	}
	getValueForPixel(e) {
		let t = this._offsets, n = this.getDecimalForPixel(e) / t.factor - t.end;
		return jl(this._table, n * this._tableRange + this._minPos, !0);
	}
}, Nl = [
	Oi,
	ms,
...
var Pl = No, Fl = t(), $ = r();
function Il() {
	let e = (0, i.useRef)(null), t = (0, i.useRef)(null), [n, r] = (0, i.useState)("7d"), [a, o] = (0, i.useState)([]), [s, c] = (0, i.useState)([]), l = (e, t) => {
		let n = e.createLinearGradient(0, t.top, 0, t.bottom);
		return n.addColorStop(0, "rgba(54, 162, 235, 0.7)"), n.addColorStop(1, "rgba(54, 162, 235, 0.05)"), n;
	}, u = async (e) => {
		let t = await (await fetch(`/api/admin/statistics/sales-trend?period=${e}`)).json();
		o(t.map((e) => e.label)), c(t.map((e) => e.sales));
	};
	return (0, i.useEffect)(() => {
		u(n);
	}, [n]), (0, i.useEffect)(() => {
		if (!e.current) return;
		let n = e.current.getContext("2d");
		return t.current && t.current.destroy(), t.current = new Pl(n, {
			type: "line",
			data: {
				labels: a,
				datasets: [{
		...
		children: [/* @__PURE__ */ (0, $.jsxs)("div", {
			...
			children: /* @__PURE__ */ (0, $.jsx)("canvas", { ref: e })
		})]
	});
}
var Ll = document.getElementById("sales-dashboard-root");
Ll && (0, Fl.createRoot)(Ll).render(/* @__PURE__ */ (0, $.jsx)(Il, {}));
//#endregion
